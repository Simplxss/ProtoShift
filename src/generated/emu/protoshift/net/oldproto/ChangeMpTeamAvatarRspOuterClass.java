...
public final class ChangeMpTeamAvatarRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.internal_static_ChangeMpTeamAvatarRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.internal_static_ChangeMpTeamAvatarRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp.class, emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp other = (emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.internal_static_ChangeMpTeamAvatarRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp build() {
        emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp buildPartial() {
        emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp result = new emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp other) {
        if (other == emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp();
    }

    public static emu.protoshift.net.oldproto.ChangeMpTeamAvatarRspOuterClass.ChangeMpTeamAvatarRsp getDefaultInstance() {
