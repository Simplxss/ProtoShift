...
public final class GCGTCTavernChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.class, emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData other = (emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData build() {
        emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData buildPartial() {
        emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData result = new emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData other) {
        if (other == emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData();
    }

    public static emu.protoshift.net.oldproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\034\n\024unlock_level_id_list\030\013 \003(\rB\035\n\033emu." +
