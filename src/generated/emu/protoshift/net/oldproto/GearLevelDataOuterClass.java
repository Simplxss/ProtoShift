...
public final class GearLevelDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GearLevelDataOuterClass.internal_static_GearLevelData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GearLevelDataOuterClass.internal_static_GearLevelData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData.class, emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData other = (emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData) obj;
    ...
    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GearLevelDataOuterClass.internal_static_GearLevelData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData build() {
        emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData buildPartial() {
        emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData result = new emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData) {
          return mergeFrom((emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData other) {
        if (other == emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData();
    }

    public static emu.protoshift.net.oldproto.GearLevelDataOuterClass.GearLevelData getDefaultInstance() {
