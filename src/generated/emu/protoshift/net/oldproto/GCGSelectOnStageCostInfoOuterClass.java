...
public final class GCGSelectOnStageCostInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.class, emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo other = (emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo build() {
        emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo buildPartial() {
        emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result = new emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result) {
        if (costMapBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo other) {
        if (other == emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.getDefaultInstance()) return this;
        if (costMapBuilder_ == null) {
    ...
    private static final emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo();
    }

    public static emu.protoshift.net.oldproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo getDefaultInstance() {
