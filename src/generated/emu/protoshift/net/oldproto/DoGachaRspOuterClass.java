...
public final class DoGachaRspOuterClass {
  ...
  public interface DoGachaRspOrBuilder extends
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem> 
        getGachaItemListList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 6;</code>
     */
    emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem getGachaItemList(int index);
    /**
     * <code>repeated .GachaItem gacha_item_list = 6;</code>
     */
     ...
     * <code>repeated .GachaItem gacha_item_list = 6;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 6;</code>
     */
    emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.class, emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.Builder.class);
    }
    ...
    private java.util.List<emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem> gachaItemList_;
    /**
     * <code>repeated .GachaItem gacha_item_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem> getGachaItemListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList() {
      return gachaItemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem getGachaItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index) {
      return gachaItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp other = (emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp build() {
        emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp buildPartial() {
        emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result = new emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result) {
        if (gachaItemListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp other) {
        if (other == emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.parser(),
                        extensionRegistry);
                if (gachaItemListBuilder_ == null) {
                  ensureGachaItemListIsMutable();
      ...
      private void ensureGachaItemListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          gachaItemList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem>(gachaItemList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> gachaItemListBuilder_;
      ...
      public Builder setGachaItemList(
          int index, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setGachaItemList(
          int index, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 6;</code>
       */
      public Builder addGachaItemList(emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addGachaItemList(
          emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
      ...
      public Builder addAllGachaItemList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem> values) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 6;</code>
       */
      public emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder getGachaItemListBuilder(
          int index) {
       ...
       * <code>repeated .GachaItem gacha_item_list = 6;</code>
       */
      public emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder() {
        return getGachaItemListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 6;</code>
       */
      public emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder(
          int index) {
        return getGachaItemListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 6;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder> 
           getGachaItemListBuilderList() {
        return getGachaItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItem.Builder, emu.protoshift.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
    ...
    private static final emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp();
    }

    public static emu.protoshift.net.oldproto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "emId\030\001 \001(\rB\035\n\033emu.protoshift.net.oldprot" +
      "ob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.GachaItemOuterClass.getDescriptor(),
        });
    internal_static_DoGachaRsp_descriptor =
