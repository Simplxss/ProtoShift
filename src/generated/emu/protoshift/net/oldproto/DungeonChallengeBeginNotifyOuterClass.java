...
public final class DungeonChallengeBeginNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.internal_static_DungeonChallengeBeginNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.internal_static_DungeonChallengeBeginNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.class, emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify other = (emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.internal_static_DungeonChallengeBeginNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify build() {
        emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify buildPartial() {
        emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify result = new emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify other) {
        if (other == emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify();
    }

    public static emu.protoshift.net.oldproto.DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify getDefaultInstance() {
