...
public final class EnterScenePeerNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.internal_static_EnterScenePeerNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.internal_static_EnterScenePeerNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify.class, emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify other = (emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.internal_static_EnterScenePeerNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify build() {
        emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify buildPartial() {
        emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify result = new emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify other) {
        if (other == emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify();
    }

    public static emu.protoshift.net.oldproto.EnterScenePeerNotifyOuterClass.EnterScenePeerNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\rdest_scene_id\030\003 \001(\rB\035\n\033emu.protoshift." +
