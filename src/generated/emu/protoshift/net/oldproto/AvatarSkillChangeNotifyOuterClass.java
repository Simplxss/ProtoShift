...
public final class AvatarSkillChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.class, emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify other = (emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify build() {
        emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify buildPartial() {
        emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify result = new emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify other) {
        if (other == emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify();
    }

    public static emu.protoshift.net.oldproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify getDefaultInstance() {
