...
public final class FishtankFishInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.internal_static_FishtankFishInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.internal_static_FishtankFishInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo.class, emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo other = (emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.internal_static_FishtankFishInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo build() {
        emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo buildPartial() {
        emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo result = new emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo other) {
        if (other == emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo();
    }

    public static emu.protoshift.net.oldproto.FishtankFishInfoOuterClass.FishtankFishInfo getDefaultInstance() {
