...
public final class BMBBLDNMBAHOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.internal_static_BMBBLDNMBAH_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.internal_static_BMBBLDNMBAH_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH.class, emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH other = (emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH) obj;
    ...
    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAHOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.internal_static_BMBBLDNMBAH_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH build() {
        emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH buildPartial() {
        emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH result = new emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH) {
          return mergeFrom((emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH other) {
        if (other == emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH.getDefaultInstance()) return this;
      ...
      private void ensureEBPKNMIECOJIsMutable() {
        if (!eBPKNMIECOJ_.isModifiable()) {
          eBPKNMIECOJ_ = makeMutableCopy(eBPKNMIECOJ_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensureNHLKMDBPCKCIsMutable() {
        if (!nHLKMDBPCKC_.isModifiable()) {
          nHLKMDBPCKC_ = makeMutableCopy(nHLKMDBPCKC_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
      ...
      private void ensureKMLIFABIOPAIsMutable() {
        if (!kMLIFABIOPA_.isModifiable()) {
          kMLIFABIOPA_ = makeMutableCopy(kMLIFABIOPA_);
        }
        bitField0_ |= 0x00000010;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH();
    }

    public static emu.protoshift.net.oldproto.BMBBLDNMBAHOuterClass.BMBBLDNMBAH getDefaultInstance() {
