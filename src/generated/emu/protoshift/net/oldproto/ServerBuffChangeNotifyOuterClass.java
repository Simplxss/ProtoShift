...
public final class ServerBuffChangeNotifyOuterClass {
  ...
  public interface ServerBuffChangeNotifyOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.class, emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.Builder.class);
    }
    ...
    public enum ServerBuffChangeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The serverBuffChangeType.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType() {
      emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType result = emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.forNumber(serverBuffChangeType_);
      return result == null ? emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (serverBuffChangeType_ != emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.SERVER_BUFF_CHANGE_TYPE_ADD_SERVER_BUFF.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify other = (emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify build() {
        emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify buildPartial() {
        emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result = new emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result) {
        if (serverBuffListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify other) {
        if (other == emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDefaultInstance()) return this;
        if (serverBuffListBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType() {
        emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType result = emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.forNumber(serverBuffChangeType_);
        return result == null ? emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setServerBuffChangeType(emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000004;
    ...
    private static final emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify();
    }

    public static emu.protoshift.net.oldproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_TYPE_DEL_SERVER_BUFF\020\001B\035\n\033emu.protoshif" +
