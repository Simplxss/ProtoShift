...
public final class AvatarExcelInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.internal_static_AvatarExcelInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.internal_static_AvatarExcelInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.class, emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo other = (emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.internal_static_AvatarExcelInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo build() {
        emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo buildPartial() {
        emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo result = new emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo other) {
        if (other == emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo();
    }

    public static emu.protoshift.net.oldproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ash\030\004 \001(\004\022\032\n\022combat_config_hash\030\005 \001(\004B\035\n" +
