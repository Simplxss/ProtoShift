...
public final class ReunionWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.internal_static_ReunionWatcherInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.internal_static_ReunionWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo.class, emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo other = (emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.internal_static_ReunionWatcherInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo build() {
        emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo buildPartial() {
        emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo result = new emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo other) {
        if (other == emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo();
    }

    public static emu.protoshift.net.oldproto.ReunionWatcherInfoOuterClass.ReunionWatcherInfo getDefaultInstance() {
