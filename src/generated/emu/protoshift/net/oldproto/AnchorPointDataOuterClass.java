...
public final class AnchorPointDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.class, emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData other = (emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData) obj;
    ...
    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData build() {
        emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData buildPartial() {
        emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData result = new emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData) {
          return mergeFrom((emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData other) {
        if (other == emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData();
    }

    public static emu.protoshift.net.oldproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstance() {
