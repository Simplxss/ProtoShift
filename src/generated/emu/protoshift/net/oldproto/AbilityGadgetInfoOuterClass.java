...
public final class AbilityGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.class, emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other = (emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo build() {
        emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo buildPartial() {
        emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = new emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other) {
        if (other == emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo();
    }

    public static emu.protoshift.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstance() {
