...
public final class HuntingSuccessNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.internal_static_HuntingSuccessNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.internal_static_HuntingSuccessNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify.class, emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify other = (emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.internal_static_HuntingSuccessNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify build() {
        emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify buildPartial() {
        emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify result = new emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify other) {
        if (other == emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify();
    }

    public static emu.protoshift.net.oldproto.HuntingSuccessNotifyOuterClass.HuntingSuccessNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ng_pair\030\001 \001(\0132\014.HuntingPairB\035\n\033emu.proto" +
