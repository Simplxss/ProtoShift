...
public final class SocialDetailOuterClass {
  ...
  public interface SocialDetailOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState();
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
     ...
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail.class, emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder.class);
    }
     ...
     * @return The onlineState.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
      emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.forNumber(onlineState_);
      return result == null ? emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> showAvatarInfoList_;
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (onlineState_ != emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.FRIEND_ONLINE_STATE_DISCONNECT.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail other = (emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail) obj;
    ...
    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail build() {
        emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail buildPartial() {
        emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail result = new emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail result) {
        if (showAvatarInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail) {
          return mergeFrom((emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail other) {
        if (other == emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.parser(),
                        extensionRegistry);
                if (showAvatarInfoListBuilder_ == null) {
                  ensureShowAvatarInfoListIsMutable();
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
        emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.forNumber(onlineState_);
        return result == null ? emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setOnlineState(emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000100;
      ...
      private void ensureShowAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00200000) != 0)) {
          showAvatarInfoList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo>(showAvatarInfoList_);
          bitField0_ |= 0x00200000;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public Builder addShowAvatarInfoList(emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShowAvatarInfoList(
          emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder> 
           getShowAvatarInfoListBuilderList() {
        return getShowAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
          getShowAvatarInfoListFieldBuilder() {
        if (showAvatarInfoListBuilder_ == null) {
    ...
    private static final emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail();
    }

    public static emu.protoshift.net.oldproto.SocialDetailOuterClass.SocialDetail getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.protoshift.net.oldproto.FriendOnlineStateOuterClass.getDescriptor(),
          emu.protoshift.net.oldproto.SocialShowAvatarInfoOuterClass.getDescriptor(),
