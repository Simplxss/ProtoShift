...
public final class SceneWeatherForcastRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.internal_static_SceneWeatherForcastRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.internal_static_SceneWeatherForcastRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp.class, emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp other = (emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.internal_static_SceneWeatherForcastRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp build() {
        emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp buildPartial() {
        emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp result = new emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp other) {
        if (other == emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp.getDefaultInstance()) return this;
      ...
      private void ensureForcastClimateListIsMutable() {
        if (!forcastClimateList_.isModifiable()) {
          forcastClimateList_ = makeMutableCopy(forcastClimateList_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp();
    }

    public static emu.protoshift.net.oldproto.SceneWeatherForcastRspOuterClass.SceneWeatherForcastRsp getDefaultInstance() {
