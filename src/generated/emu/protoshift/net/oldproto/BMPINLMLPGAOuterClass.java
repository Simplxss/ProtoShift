...
public final class BMPINLMLPGAOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.internal_static_BMPINLMLPGA_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.internal_static_BMPINLMLPGA_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA.class, emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA.Builder.class);
    }
    ...
    private boolean jLMBMDACMEN_ = false;
    /**
     * <code>bool JLMBMDACMEN = 3;</code>
     * @return The jLMBMDACMEN.
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA other = (emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA) obj;
    ...
    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.internal_static_BMPINLMLPGA_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA build() {
        emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA buildPartial() {
        emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA result = new emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA) {
          return mergeFrom((emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA other) {
        if (other == emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA();
    }

    public static emu.protoshift.net.oldproto.BMPINLMLPGAOuterClass.BMPINLMLPGA getDefaultInstance() {
