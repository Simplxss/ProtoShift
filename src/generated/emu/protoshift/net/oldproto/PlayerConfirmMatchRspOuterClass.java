...
public final class PlayerConfirmMatchRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.internal_static_PlayerConfirmMatchRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.internal_static_PlayerConfirmMatchRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp.class, emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp other = (emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.internal_static_PlayerConfirmMatchRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp build() {
        emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp buildPartial() {
        emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp result = new emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp other) {
        if (other == emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp();
    }

    public static emu.protoshift.net.oldproto.PlayerConfirmMatchRspOuterClass.PlayerConfirmMatchRsp getDefaultInstance() {
