...
public final class PBNavMeshPolyOuterClass {
  ...
  public interface PBNavMeshPolyOrBuilder extends
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList();
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 11;</code>
     ...
     */
    emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index);
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 11;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.class, emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.Builder.class);
    }
    ...
    public enum EdgeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
        java.lang.Integer, emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> edgeTypes_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
                java.lang.Integer, emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>() {
              public emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType convert(java.lang.Integer from) {
                emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType result = emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.forNumber(from);
                return result == null ? emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.UNRECOGNIZED : result;
              }
            };
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 11;</code>
     ...
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList() {
      return new com.google.protobuf.Internal.ListAdapter<
          java.lang.Integer, emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>(edgeTypes_, edgeTypes_converter_);
    }
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 11;</code>
     * @return The count of edgeTypes.
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other = (emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) obj;
    ...
    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPolyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly build() {
        emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly buildPartial() {
        emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = new emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) {
          return mergeFrom((emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other) {
        if (other == emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance()) return this;
        if (other.getArea() != 0) {
      ...
      public Builder setEdgeTypes(
          int index, emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
       ...
       * @return This builder for chaining.
       */
      public Builder addEdgeTypes(emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureEdgeTypesIsMutable();
      ...
      public Builder addAllEdgeTypes(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> values) {
        ensureEdgeTypesIsMutable();
        for (emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value : values) {
          edgeTypes_.add(value.getNumber());
        }
        onChanged();
        return this;
      ...
      private void ensureVectsIsMutable() {
        if (!vects_.isModifiable()) {
          vects_ = makeMutableCopy(vects_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly();
    }

    public static emu.protoshift.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstance() {
