...
public final class StopServerInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.StopServerInfoOuterClass.internal_static_StopServerInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.StopServerInfoOuterClass.internal_static_StopServerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.class, emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo other = (emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.StopServerInfoOuterClass.internal_static_StopServerInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo build() {
        emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo buildPartial() {
        emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo result = new emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo other) {
        if (other == emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo();
    }

    public static emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo getDefaultInstance() {
