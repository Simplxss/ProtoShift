...
public final class GetAuthkeyRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.internal_static_GetAuthkeyRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.internal_static_GetAuthkeyRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp.class, emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp other = (emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.internal_static_GetAuthkeyRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp build() {
        emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp buildPartial() {
        emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp result = new emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp other) {
        if (other == emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp();
    }

    public static emu.protoshift.net.oldproto.GetAuthkeyRspOuterClass.GetAuthkeyRsp getDefaultInstance() {
