...
public final class ExpeditionStartReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.class, emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq other = (emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq) obj;
    ...
    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq build() {
        emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq buildPartial() {
        emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq result = new emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq) {
          return mergeFrom((emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq other) {
        if (other == emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq();
    }

    public static emu.protoshift.net.oldproto.ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstance() {
