...
public final class BlossomChestInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.internal_static_BlossomChestInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.internal_static_BlossomChestInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo.class, emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo other = (emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.internal_static_BlossomChestInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo build() {
        emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo buildPartial() {
        emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo result = new emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo other) {
        if (other == emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
    ...
    private static final emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo();
    }

    public static emu.protoshift.net.oldproto.BlossomChestInfoOuterClass.BlossomChestInfo getDefaultInstance() {
