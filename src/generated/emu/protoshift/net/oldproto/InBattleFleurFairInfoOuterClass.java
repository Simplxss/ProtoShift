...
public final class InBattleFleurFairInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.internal_static_InBattleFleurFairInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.internal_static_InBattleFleurFairInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo.class, emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo other = (emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.internal_static_InBattleFleurFairInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo build() {
        emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo buildPartial() {
        emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo result = new emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo other) {
        if (other == emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo.getDefaultInstance()) return this;
      ...
      private void ensureFLKGLKPOEDPIsMutable() {
        if (!fLKGLKPOEDP_.isModifiable()) {
          fLKGLKPOEDP_ = makeMutableCopy(fLKGLKPOEDP_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensureGBFDDCJFLGOIsMutable() {
        if (!gBFDDCJFLGO_.isModifiable()) {
          gBFDDCJFLGO_ = makeMutableCopy(gBFDDCJFLGO_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo();
    }

    public static emu.protoshift.net.oldproto.InBattleFleurFairInfoOuterClass.InBattleFleurFairInfo getDefaultInstance() {
