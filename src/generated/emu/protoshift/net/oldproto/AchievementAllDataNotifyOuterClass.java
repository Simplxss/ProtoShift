...
public final class AchievementAllDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.class, emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other = (emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify build() {
        emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify buildPartial() {
        emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = new emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result) {
        if (achievementListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other) {
        if (other == emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify();
    }

    public static emu.protoshift.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hievement_list\030\t \003(\0132\014.AchievementB\035\n\033em" +
