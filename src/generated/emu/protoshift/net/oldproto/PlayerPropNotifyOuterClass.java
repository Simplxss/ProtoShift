...
emu.protoshift.net.oldproto.PropValueOuterClass.PropValue defaultValue);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.internal_static_PlayerPropNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.internal_static_PlayerPropNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify.class, emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.protoshift.net.oldproto.PropValueOuterClass.PropValue> defaultEntry =
              ...
              .<java.lang.Integer, emu.protoshift.net.oldproto.PropValueOuterClass.PropValue>newDefaultInstance(
                  emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.internal_static_PlayerPropNotify_PropMapEntry_descriptor, 
...
emu.protoshift.net.oldproto.PropValueOuterClass.PropValue defaultValue) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify other = (emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.internal_static_PlayerPropNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify build() {
        emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify buildPartial() {
        emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify result = new emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify other) {
        if (other == emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify.getDefaultInstance()) return this;
...
emu.protoshift.net.oldproto.PropValueOuterClass.PropValue defaultValue) {
    ...
    private static final emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify();
    }

    public static emu.protoshift.net.oldproto.PlayerPropNotifyOuterClass.PlayerPropNotify getDefaultInstance() {
