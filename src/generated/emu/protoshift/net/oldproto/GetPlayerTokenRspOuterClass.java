...
public final class GetPlayerTokenRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.class, emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.Builder.class);
    }
    ...
    private emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo stopServer_;
    /**
     * <code>.StopServerInfo stop_server = 875;</code>
     * @return Whether the stopServer field is set.
     */
    ...
    public emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo getStopServer() {
      return stopServer_ == null ? emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServer_;
    }
    /**
     * <code>.StopServerInfo stop_server = 875;</code>
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp other = (emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.internal_static_GetPlayerTokenRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp build() {
        emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp buildPartial() {
        emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp result = new emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp other) {
        if (other == emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp.getDefaultInstance()) return this;
      ...
      public Builder mergeStopServer(emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo value) {
        if (stopServerBuilder_ == null) {
          if (((bitField0_ & 0x00000010) != 0) &&
            stopServer_ != null &&
            stopServer_ != emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance()) {
      ...
      public emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfoOrBuilder getStopServerOrBuilder() {
        if (stopServerBuilder_ != null) {
          ...
          return stopServer_ == null ?
              emu.protoshift.net.oldproto.StopServerInfoOuterClass.StopServerInfo.getDefaultInstance() : stopServer_;
        }
      }
      /**
       * <code>.StopServerInfo stop_server = 875;</code>
    ...
    private static final emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp();
    }

    public static emu.protoshift.net.oldproto.GetPlayerTokenRspOuterClass.GetPlayerTokenRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\t\022\026\n\rcloudClientIp\030\374\003 \001(\rB\035\n\033emu.prot" +
