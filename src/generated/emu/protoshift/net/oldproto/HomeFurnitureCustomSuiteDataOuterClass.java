...
public final class HomeFurnitureCustomSuiteDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.class, emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData other = (emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData) obj;
    ...
    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData build() {
        emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData buildPartial() {
        emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData result = new emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData) {
          return mergeFrom((emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData other) {
        if (other == emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData();
    }

    public static emu.protoshift.net.oldproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData getDefaultInstance() {
