...
public final class LuaEnvironmentEffectNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.class, emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other = (emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify build() {
        emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify buildPartial() {
        emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result = new emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other) {
        if (other == emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                ...
                ensureFloatParamListIsMutable(alloc / 4);
      ...
      private void ensureIntParamListIsMutable() {
        if (!intParamList_.isModifiable()) {
          intParamList_ = makeMutableCopy(intParamList_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
      ...
      private void ensureFloatParamListIsMutable() {
        if (!floatParamList_.isModifiable()) {
          floatParamList_ = makeMutableCopy(floatParamList_);
        }
        bitField0_ |= 0x00000008;
      }
      private void ensureFloatParamListIsMutable(int capacity) {
        if (!floatParamList_.isModifiable()) {
          floatParamList_ = makeMutableCopy(floatParamList_, capacity);
        }
        bitField0_ |= 0x00000008;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify();
    }

    public static emu.protoshift.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \003(\005\022\030\n\020float_param_list\030\003 \003(\002B\035\n\033emu.pr" +
