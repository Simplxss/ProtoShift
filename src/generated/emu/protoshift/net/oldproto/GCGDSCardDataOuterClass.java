...
public final class GCGDSCardDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.internal_static_GCGDSCardData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.internal_static_GCGDSCardData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.class, emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData other = (emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.internal_static_GCGDSCardData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData build() {
        emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData buildPartial() {
        emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData result = new emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData other) {
        if (other == emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.getDefaultInstance()) return this;
      ...
      private void ensureCLHNMOECDELIsMutable() {
        if (!cLHNMOECDEL_.isModifiable()) {
          cLHNMOECDEL_ = makeMutableCopy(cLHNMOECDEL_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensureMGLKBANJKKAIsMutable() {
        if (!mGLKBANJKKA_.isModifiable()) {
          mGLKBANJKKA_ = makeMutableCopy(mGLKBANJKKA_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData();
    }

    public static emu.protoshift.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_id\030\017 \001(\r\022\023\n\013proficiency\030\010 \001(\rB\035\n\033emu.pr" +
