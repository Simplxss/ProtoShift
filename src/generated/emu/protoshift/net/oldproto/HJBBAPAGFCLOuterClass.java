...
public final class HJBBAPAGFCLOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.internal_static_HJBBAPAGFCL_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.internal_static_HJBBAPAGFCL_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL.class, emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL other = (emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL) obj;
    ...
    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCLOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.internal_static_HJBBAPAGFCL_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL build() {
        emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL buildPartial() {
        emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL result = new emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL) {
          return mergeFrom((emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL other) {
        if (other == emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL();
    }

    public static emu.protoshift.net.oldproto.HJBBAPAGFCLOuterClass.HJBBAPAGFCL getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "d\030\003 \001(\r\022\023\n\013ACNPNNDGIBB\030\007 \003(\rB\035\n\033emu.prot" +
