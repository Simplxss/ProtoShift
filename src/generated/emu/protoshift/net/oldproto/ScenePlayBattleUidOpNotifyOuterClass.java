...
public final class ScenePlayBattleUidOpNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.internal_static_ScenePlayBattleUidOpNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.internal_static_ScenePlayBattleUidOpNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify.class, emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify other = (emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.internal_static_ScenePlayBattleUidOpNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify build() {
        emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify buildPartial() {
        emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify result = new emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify other) {
        if (other == emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify.getDefaultInstance()) return this;
      ...
      private void ensureParamTargetListIsMutable() {
        if (!paramTargetList_.isModifiable()) {
          paramTargetList_ = makeMutableCopy(paramTargetList_);
        }
        bitField0_ |= 0x00000100;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify();
    }

    public static emu.protoshift.net.oldproto.ScenePlayBattleUidOpNotifyOuterClass.ScenePlayBattleUidOpNotify getDefaultInstance() {
