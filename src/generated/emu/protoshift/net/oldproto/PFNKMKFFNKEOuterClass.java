...
public final class PFNKMKFFNKEOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.internal_static_PFNKMKFFNKE_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.internal_static_PFNKMKFFNKE_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE.class, emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE other = (emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE) obj;
    ...
    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKEOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.internal_static_PFNKMKFFNKE_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE build() {
        emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE buildPartial() {
        emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE result = new emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE) {
          return mergeFrom((emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE other) {
        if (other == emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE();
    }

    public static emu.protoshift.net.oldproto.PFNKMKFFNKEOuterClass.PFNKMKFFNKE getDefaultInstance() {
