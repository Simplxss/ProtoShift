...
public final class MailDataOuterClass {
  ...
  public interface MailDataOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent getMailTextContent();
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     */
    emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder();

    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<emu.protoshift.net.oldproto.MailItemOuterClass.MailItem> 
        getItemListList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.protoshift.net.oldproto.MailItemOuterClass.MailItem getItemList(int index);
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
     ...
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index);
     ...
     */
    emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState();
  }
  /**
   * <pre>
   * Obf: NGGHHPIHNPM
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.MailDataOuterClass.internal_static_MailData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.MailDataOuterClass.internal_static_MailData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.MailDataOuterClass.MailData.class, emu.protoshift.net.oldproto.MailDataOuterClass.MailData.Builder.class);
    }
    ...
    private emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent mailTextContent_;
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     * @return Whether the mailTextContent field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent getMailTextContent() {
      return mailTextContent_ == null ? emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
    }
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
      return mailTextContent_ == null ? emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
    }

    public static final int ITEM_LIST_FIELD_NUMBER = 7;
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.oldproto.MailItemOuterClass.MailItem> itemList_;
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.MailItemOuterClass.MailItem> getItemListList() {
      return itemList_;
    }
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList() {
      return itemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.MailItemOuterClass.MailItem getItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index) {
      return itemList_.get(index);
    }
     ...
     * @return The collectState.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState() {
      emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState result = emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState.forNumber(collectState_);
      return result == null ? emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (collectState_ != emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState.MAIL_COLLECT_STATE_COLLECTIBLE_UNKNOWN.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.MailDataOuterClass.MailData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.MailDataOuterClass.MailData other = (emu.protoshift.net.oldproto.MailDataOuterClass.MailData) obj;
    ...
    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.MailDataOuterClass.MailData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.MailDataOuterClass.MailDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.MailDataOuterClass.internal_static_MailData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.MailDataOuterClass.MailData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.MailDataOuterClass.MailData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.MailDataOuterClass.MailData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.MailDataOuterClass.MailData build() {
        emu.protoshift.net.oldproto.MailDataOuterClass.MailData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.MailDataOuterClass.MailData buildPartial() {
        emu.protoshift.net.oldproto.MailDataOuterClass.MailData result = new emu.protoshift.net.oldproto.MailDataOuterClass.MailData(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.MailDataOuterClass.MailData result) {
        if (itemListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.MailDataOuterClass.MailData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.MailDataOuterClass.MailData) {
          return mergeFrom((emu.protoshift.net.oldproto.MailDataOuterClass.MailData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.MailDataOuterClass.MailData other) {
        if (other == emu.protoshift.net.oldproto.MailDataOuterClass.MailData.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                emu.protoshift.net.oldproto.MailItemOuterClass.MailItem m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.parser(),
                        extensionRegistry);
                if (itemListBuilder_ == null) {
                  ensureItemListIsMutable();
                  itemList_.add(m);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent, emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder, emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder> mailTextContentBuilder_;
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       * @return Whether the mailTextContent field is set.
       */
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public Builder setMailTextContent(emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setMailTextContent(
          emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder builderForValue) {
        if (mailTextContentBuilder_ == null) {
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public Builder mergeMailTextContent(emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (((bitField0_ & 0x00000002) != 0) &&
            mailTextContent_ != null &&
            mailTextContent_ != emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance()) {
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder getMailTextContentBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
      ...
      public emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
        if (mailTextContentBuilder_ != null) {
          ...
          return mailTextContent_ == null ?
              emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
        }
      }
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent, emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder, emu.protoshift.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder> 
          getMailTextContentFieldBuilder() {
        if (mailTextContentBuilder_ == null) {
      ...
      private void ensureItemListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          itemList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.MailItemOuterClass.MailItem>(itemList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.MailItemOuterClass.MailItem, emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder, emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder> itemListBuilder_;
      ...
      public Builder setItemList(
          int index, emu.protoshift.net.oldproto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setItemList(
          int index, emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public Builder addItemList(emu.protoshift.net.oldproto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addItemList(
          emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
      ...
      public Builder addAllItemList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.MailItemOuterClass.MailItem> values) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder getItemListBuilder(
          int index) {
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder addItemListBuilder() {
        return getItemListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder addItemListBuilder(
          int index) {
        return getItemListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder> 
           getItemListBuilderList() {
        return getItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.MailItemOuterClass.MailItem, emu.protoshift.net.oldproto.MailItemOuterClass.MailItem.Builder, emu.protoshift.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
          getItemListFieldBuilder() {
        if (itemListBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState() {
        emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState result = emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState.forNumber(collectState_);
        return result == null ? emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setCollectState(emu.protoshift.net.oldproto.MailCollectStateOuterClass.MailCollectState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000400;
    ...
    private static final emu.protoshift.net.oldproto.MailDataOuterClass.MailData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.MailDataOuterClass.MailData();
    }

    public static emu.protoshift.net.oldproto.MailDataOuterClass.MailData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.MailTextContentOuterClass.getDescriptor(),
          emu.protoshift.net.oldproto.MailItemOuterClass.getDescriptor(),
          emu.protoshift.net.oldproto.MailCollectStateOuterClass.getDescriptor(),
        });
    internal_static_MailData_descriptor =
