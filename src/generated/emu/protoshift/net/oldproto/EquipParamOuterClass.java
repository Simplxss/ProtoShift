...
public final class EquipParamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.EquipParamOuterClass.internal_static_EquipParam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.EquipParamOuterClass.internal_static_EquipParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam.class, emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam other = (emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam) obj;
    ...
    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.EquipParamOuterClass.internal_static_EquipParam_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam build() {
        emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam buildPartial() {
        emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam result = new emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam) {
          return mergeFrom((emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam other) {
        if (other == emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam();
    }

    public static emu.protoshift.net.oldproto.EquipParamOuterClass.EquipParam getDefaultInstance() {
