...
public final class SceneFishInfoOuterClass {
  ...
  public interface SceneFishInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.VectorOuterClass.Vector getFishPoolPos();
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    emu.protoshift.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.class, emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.Builder.class);
    }
    ...
    private emu.protoshift.net.oldproto.VectorOuterClass.Vector fishPoolPos_;
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     * @return Whether the fishPoolPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.VectorOuterClass.Vector getFishPoolPos() {
      return fishPoolPos_ == null ? emu.protoshift.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
    }
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
      return fishPoolPos_ == null ? emu.protoshift.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo other = (emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo build() {
        emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo buildPartial() {
        emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo result = new emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo other) {
        if (other == emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.oldproto.VectorOuterClass.Vector, emu.protoshift.net.oldproto.VectorOuterClass.Vector.Builder, emu.protoshift.net.oldproto.VectorOuterClass.VectorOrBuilder> fishPoolPosBuilder_;
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
       * @return Whether the fishPoolPos field is set.
       */
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder setFishPoolPos(emu.protoshift.net.oldproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder mergeFishPoolPos(emu.protoshift.net.oldproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            fishPoolPos_ != null &&
            fishPoolPos_ != emu.protoshift.net.oldproto.VectorOuterClass.Vector.getDefaultInstance()) {
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public emu.protoshift.net.oldproto.VectorOuterClass.Vector.Builder getFishPoolPosBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
      ...
      public emu.protoshift.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
        if (fishPoolPosBuilder_ != null) {
          ...
          return fishPoolPos_ == null ?
              emu.protoshift.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
        }
      }
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
    ...
    private static final emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo();
    }

    public static emu.protoshift.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\027\n\017last_shock_time\030\005 \001(\rB\035\n\033emu.protosh" +
