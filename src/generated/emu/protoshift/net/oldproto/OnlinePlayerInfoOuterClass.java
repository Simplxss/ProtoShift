...
public final class OnlinePlayerInfoOuterClass {
  ...
  public interface OnlinePlayerInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType getMpSettingType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.internal_static_OnlinePlayerInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.internal_static_OnlinePlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.class, emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.Builder.class);
    }
     ...
     * @return The mpSettingType.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType getMpSettingType() {
      emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType result = emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType.forNumber(mpSettingType_);
      return result == null ? emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (mpSettingType_ != emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType.MP_SETTING_TYPE_NO_ENTER.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo other = (emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.internal_static_OnlinePlayerInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo build() {
        emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo buildPartial() {
        emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo result = new emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo other) {
        if (other == emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType getMpSettingType() {
        emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType result = emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType.forNumber(mpSettingType_);
        return result == null ? emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setMpSettingType(emu.protoshift.net.oldproto.MpSettingTypeOuterClass.MpSettingType value) {
        if (value == null) {
    ...
    private static final emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo();
    }

    public static emu.protoshift.net.oldproto.OnlinePlayerInfoOuterClass.OnlinePlayerInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.MpSettingTypeOuterClass.getDescriptor(),
