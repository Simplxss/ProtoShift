...
public final class ReadMailNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify.class, emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify other = (emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify build() {
        emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify buildPartial() {
        emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify result = new emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify other) {
        if (other == emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify();
    }

    public static emu.protoshift.net.oldproto.ReadMailNotifyOuterClass.ReadMailNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\024\n\014mail_id_list\030\002 \003(\rB\035\n\033emu.protoshift" +
