...
public final class AvatarDelNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify.class, emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify other = (emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify build() {
        emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify buildPartial() {
        emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify result = new emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify other) {
        if (other == emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify();
    }

    public static emu.protoshift.net.oldproto.AvatarDelNotifyOuterClass.AvatarDelNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fy\022\030\n\020avatar_guid_list\030\007 \003(\004B\035\n\033emu.prot" +
