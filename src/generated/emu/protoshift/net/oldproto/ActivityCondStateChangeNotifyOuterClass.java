...
public final class ActivityCondStateChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.internal_static_ActivityCondStateChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.internal_static_ActivityCondStateChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.class, emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify other = (emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.internal_static_ActivityCondStateChangeNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify build() {
        emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify buildPartial() {
        emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify result = new emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify result) {
        if (disableTransferPointInteractionListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify other) {
        if (other == emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify.getDefaultInstance()) return this;
      ...
      private void ensureDCPENBLPKHKIsMutable() {
        if (!dCPENBLPKHK_.isModifiable()) {
          dCPENBLPKHK_ = makeMutableCopy(dCPENBLPKHK_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensurePHCOMIFAIJDIsMutable() {
        if (!pHCOMIFAIJD_.isModifiable()) {
          pHCOMIFAIJD_ = makeMutableCopy(pHCOMIFAIJD_);
        }
        bitField0_ |= 0x00000008;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify();
    }

    public static emu.protoshift.net.oldproto.ActivityCondStateChangeNotifyOuterClass.ActivityCondStateChangeNotify getDefaultInstance() {
