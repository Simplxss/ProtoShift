...
public final class InstableSprayDungeonSettleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.internal_static_InstableSprayDungeonSettleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.internal_static_InstableSprayDungeonSettleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo.class, emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo other = (emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo build() {
        emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo buildPartial() {
        emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo result = new emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo other) {
        if (other == emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo();
    }

    public static emu.protoshift.net.oldproto.InstableSprayDungeonSettleInfoOuterClass.InstableSprayDungeonSettleInfo getDefaultInstance() {
