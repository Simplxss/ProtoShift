...
public final class CodexTypeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.CodexTypeDataOuterClass.internal_static_CodexTypeData_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.CodexTypeDataOuterClass.internal_static_CodexTypeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.class, emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.CodexTypeDataOuterClass.internal_static_CodexTypeData_WeaponMaxPromoteLevelMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData other = (emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData) obj;
    ...
    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.CodexTypeDataOuterClass.internal_static_CodexTypeData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData build() {
        emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData buildPartial() {
        emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData result = new emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData) {
          return mergeFrom((emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData other) {
        if (other == emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData();
    }

    public static emu.protoshift.net.oldproto.CodexTypeDataOuterClass.CodexTypeData getDefaultInstance() {
