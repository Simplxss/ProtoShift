...
public final class ReliquaryFilterStateSaveNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.internal_static_ReliquaryFilterStateSaveNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.internal_static_ReliquaryFilterStateSaveNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify.class, emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.internal_static_ReliquaryFilterStateSaveNotify_ReliquaryFilterStateMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify other = (emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.internal_static_ReliquaryFilterStateSaveNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify build() {
        emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify buildPartial() {
        emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify result = new emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify other) {
        if (other == emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify();
    }

    public static emu.protoshift.net.oldproto.ReliquaryFilterStateSaveNotifyOuterClass.ReliquaryFilterStateSaveNotify getDefaultInstance() {
