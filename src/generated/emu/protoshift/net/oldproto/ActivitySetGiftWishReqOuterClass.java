...
public final class ActivitySetGiftWishReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.internal_static_ActivitySetGiftWishReq_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.internal_static_ActivitySetGiftWishReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq.class, emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.internal_static_ActivitySetGiftWishReq_GiftNumMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq other = (emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq) obj;
    ...
    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.internal_static_ActivitySetGiftWishReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq build() {
        emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq buildPartial() {
        emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq result = new emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq) {
          return mergeFrom((emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq other) {
        if (other == emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq();
    }

    public static emu.protoshift.net.oldproto.ActivitySetGiftWishReqOuterClass.ActivitySetGiftWishReq getDefaultInstance() {
