...
public final class QueryRegionListHttpRspOuterClass {
  ...
  public interface QueryRegionListHttpRspOrBuilder extends
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> 
        getRegionListList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index);
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
     ...
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.class, emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.Builder.class);
    }
    ...
    private java.util.List<emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> regionList_;
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> getRegionListList() {
      return regionList_;
    }
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList() {
      return regionList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index) {
      return regionList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other = (emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp build() {
        emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp buildPartial() {
        emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result = new emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result) {
        if (regionListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other) {
        if (other == emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.parser(),
                        extensionRegistry);
                if (regionListBuilder_ == null) {
                  ensureRegionListIsMutable();
                  regionList_.add(m);
      ...
      private void ensureRegionListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          regionList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo>(regionList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> regionListBuilder_;
      ...
      public Builder setRegionList(
          int index, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRegionList(
          int index, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public Builder addRegionList(emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRegionList(
          emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
      ...
      public Builder addAllRegionList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> values) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder getRegionListBuilder(
          int index) {
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder() {
        return getRegionListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder(
          int index) {
        return getRegionListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder> 
           getRegionListBuilderList() {
        return getRegionListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder, emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
    ...
    private static final emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp();
    }

    public static emu.protoshift.net.oldproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.RegionSimpleInfoOuterClass.getDescriptor(),
        });
    internal_static_QueryRegionListHttpRsp_descriptor =
