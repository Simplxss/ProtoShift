...
public final class FinishedParentQuestNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.internal_static_FinishedParentQuestNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.internal_static_FinishedParentQuestNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify.class, emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify other = (emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.internal_static_FinishedParentQuestNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify build() {
        emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify buildPartial() {
        emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify result = new emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify result) {
        if (parentQuestListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify other) {
        if (other == emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify.getDefaultInstance()) return this;
        if (parentQuestListBuilder_ == null) {
    ...
    private static final emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify();
    }

    public static emu.protoshift.net.oldproto.FinishedParentQuestNotifyOuterClass.FinishedParentQuestNotify getDefaultInstance() {
