...
public final class BartenderCompleteOrderRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.class, emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp other = (emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp build() {
        emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp buildPartial() {
        emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp result = new emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp other) {
        if (other == emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp();
    }

    public static emu.protoshift.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp getDefaultInstance() {
