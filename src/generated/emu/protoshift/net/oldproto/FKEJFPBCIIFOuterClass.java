...
public final class FKEJFPBCIIFOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.internal_static_FKEJFPBCIIF_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.internal_static_FKEJFPBCIIF_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF.class, emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF other = (emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF) obj;
    ...
    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIFOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.internal_static_FKEJFPBCIIF_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF build() {
        emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF buildPartial() {
        emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF result = new emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF) {
          return mergeFrom((emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF other) {
        if (other == emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF();
    }

    public static emu.protoshift.net.oldproto.FKEJFPBCIIFOuterClass.FKEJFPBCIIF getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "atar_id_list\030\010 \003(\004B\035\n\033emu.protoshift.net" +
      ".oldprotob\006proto3"
    };
