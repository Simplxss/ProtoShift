...
public final class GadgetGeneralRewardInfoOuterClass {
  ...
  public interface GadgetGeneralRewardInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam getItemParam();
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder();
  }
  /**
   * <pre>
   * Obf: AHGOAHBMENB
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.class, emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder.class);
    }
    ...
    private emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam itemParam_;
    /**
     * <code>.ItemParam item_param = 5;</code>
     * @return Whether the itemParam field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam getItemParam() {
      return itemParam_ == null ? emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
    }
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
      return itemParam_ == null ? emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other = (emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo build() {
        emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo buildPartial() {
        emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = new emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other) {
        if (other == emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam, emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> itemParamBuilder_;
      /**
       * <code>.ItemParam item_param = 5;</code>
       * @return Whether the itemParam field is set.
       */
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder setItemParam(emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder mergeItemParam(emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (((bitField0_ & 0x00000010) != 0) &&
            itemParam_ != null &&
            itemParam_ != emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.getDefaultInstance()) {
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.Builder getItemParamBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
      ...
      public emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
        if (itemParamBuilder_ != null) {
          ...
          return itemParam_ == null ?
              emu.protoshift.net.oldproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
        }
      }
      /**
       * <code>.ItemParam item_param = 5;</code>
    ...
    private static final emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo();
    }

    public static emu.protoshift.net.oldproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstance() {
