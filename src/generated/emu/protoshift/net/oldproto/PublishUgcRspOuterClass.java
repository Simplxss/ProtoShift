...
public final class PublishUgcRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PublishUgcRspOuterClass.internal_static_PublishUgcRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PublishUgcRspOuterClass.internal_static_PublishUgcRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp.class, emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp other = (emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PublishUgcRspOuterClass.internal_static_PublishUgcRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp build() {
        emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp buildPartial() {
        emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp result = new emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp other) {
        if (other == emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp();
    }

    public static emu.protoshift.net.oldproto.PublishUgcRspOuterClass.PublishUgcRsp getDefaultInstance() {
