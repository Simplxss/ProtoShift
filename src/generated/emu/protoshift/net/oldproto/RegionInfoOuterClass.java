...
public final class RegionInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.RegionInfoOuterClass.internal_static_RegionInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.RegionInfoOuterClass.internal_static_RegionInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo.class, emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo other = (emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.RegionInfoOuterClass.internal_static_RegionInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo build() {
        emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo buildPartial() {
        emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo result = new emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo other) {
        if (other == emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo();
    }

    public static emu.protoshift.net.oldproto.RegionInfoOuterClass.RegionInfo getDefaultInstance() {
