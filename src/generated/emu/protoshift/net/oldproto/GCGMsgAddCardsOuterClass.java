...
public final class GCGMsgAddCardsOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.class, emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards other = (emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCardsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards build() {
        emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards buildPartial() {
        emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards result = new emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards other) {
        if (other == emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards();
    }

    public static emu.protoshift.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      ".GCGReason\022\025\n\rcontroller_id\030\004 \001(\rB\035\n\033emu" +
