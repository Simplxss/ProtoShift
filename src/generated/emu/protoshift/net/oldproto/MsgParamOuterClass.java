...
public final class MsgParamOuterClass {
  ...
  public interface MsgParamOrBuilder extends
    ...
    emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.ParamCase getParamCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.MsgParamOuterClass.internal_static_MsgParam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.MsgParamOuterClass.internal_static_MsgParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.class, emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam other = (emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam) obj;
    ...
    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseFrom(
    ...
    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseFrom(
    ...
    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.MsgParamOuterClass.internal_static_MsgParam_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam build() {
        emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam buildPartial() {
        emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam result = new emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam(this);
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam result) {
        int from_bitField0_ = bitField0_;
      }

      private void buildPartialOneofs(emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam) {
          return mergeFrom((emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam other) {
        if (other == emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam();
    }

    public static emu.protoshift.net.oldproto.MsgParamOuterClass.MsgParam getDefaultInstance() {
