...
public final class RefreshBackgroundAvatarRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.internal_static_RefreshBackgroundAvatarRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.internal_static_RefreshBackgroundAvatarRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp.class, emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Long, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Long, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.internal_static_RefreshBackgroundAvatarRsp_HpFullTimeMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp other = (emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.internal_static_RefreshBackgroundAvatarRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp build() {
        emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp buildPartial() {
        emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp result = new emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp other) {
        if (other == emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp();
    }

    public static emu.protoshift.net.oldproto.RefreshBackgroundAvatarRspOuterClass.RefreshBackgroundAvatarRsp getDefaultInstance() {
