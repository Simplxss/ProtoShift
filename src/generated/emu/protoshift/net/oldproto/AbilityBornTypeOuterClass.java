...
public final class AbilityBornTypeOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.class, emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType other = (emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType) obj;
    ...
    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornTypeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType build() {
        emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType buildPartial() {
        emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType result = new emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType) {
          return mergeFrom((emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType other) {
        if (other == emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType();
    }

    public static emu.protoshift.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstance() {
