...
public final class WindFieldGalleryInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.class, emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other = (emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify build() {
        emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify buildPartial() {
        emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = new emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other) {
        if (other == emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify();
    }

    public static emu.protoshift.net.oldproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "EOBDGJ\030\005 \001(\r\022\023\n\013EHLLLIJFOJG\030\014 \001(\rB\035\n\033emu" +
