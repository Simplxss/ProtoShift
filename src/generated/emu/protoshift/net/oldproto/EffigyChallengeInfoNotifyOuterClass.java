...
public final class EffigyChallengeInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.internal_static_EffigyChallengeInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.internal_static_EffigyChallengeInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify.class, emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify other = (emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.internal_static_EffigyChallengeInfoNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify build() {
        emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify buildPartial() {
        emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify result = new emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify other) {
        if (other == emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify();
    }

    public static emu.protoshift.net.oldproto.EffigyChallengeInfoNotifyOuterClass.EffigyChallengeInfoNotify getDefaultInstance() {
