...
public final class GalleryBalloonScoreNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.internal_static_GalleryBalloonScoreNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.internal_static_GalleryBalloonScoreNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify.class, emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.internal_static_GalleryBalloonScoreNotify_UidScoreMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify other = (emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.internal_static_GalleryBalloonScoreNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify build() {
        emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify buildPartial() {
        emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify result = new emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify other) {
        if (other == emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify();
    }

    public static emu.protoshift.net.oldproto.GalleryBalloonScoreNotifyOuterClass.GalleryBalloonScoreNotify getDefaultInstance() {
