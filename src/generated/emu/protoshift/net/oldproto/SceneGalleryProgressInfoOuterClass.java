...
public final class SceneGalleryProgressInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.internal_static_SceneGalleryProgressInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.internal_static_SceneGalleryProgressInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo.class, emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo other = (emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.internal_static_SceneGalleryProgressInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo build() {
        emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo buildPartial() {
        emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo result = new emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo other) {
        if (other == emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo();
    }

    public static emu.protoshift.net.oldproto.SceneGalleryProgressInfoOuterClass.SceneGalleryProgressInfo getDefaultInstance() {
