...
public final class WatcherEventTypeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.internal_static_WatcherEventTypeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.internal_static_WatcherEventTypeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify.class, emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify other = (emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.internal_static_WatcherEventTypeNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify build() {
        emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify buildPartial() {
        emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify result = new emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify other) {
        if (other == emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify();
    }

    public static emu.protoshift.net.oldproto.WatcherEventTypeNotifyOuterClass.WatcherEventTypeNotify getDefaultInstance() {
