...
public final class PlayerApplyEnterMpResultNotifyOuterClass {
  ...
  public interface PlayerApplyEnterMpResultNotifyOrBuilder extends
     ...
     * @return The reason.
     */
    emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.class, emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Builder.class);
    }
    ...
    public enum Reason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The reason.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason() {
      emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason result = emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.forNumber(reason_);
      return result == null ? emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.REASON_PLAYER_JUDGE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify other = (emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify build() {
        emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify buildPartial() {
        emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify result = new emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify other) {
        if (other == emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason() {
        emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason result = emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.forNumber(reason_);
        return result == null ? emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason value) {
        if (value == null) {
    ...
    private static final emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify();
    }

    public static emu.protoshift.net.oldproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\025\n\021REASON_MAX_PLAYER\020\rB\035\n\033emu.protoshift" +
