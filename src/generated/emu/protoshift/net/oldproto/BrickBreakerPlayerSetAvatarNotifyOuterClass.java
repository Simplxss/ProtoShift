...
public final class BrickBreakerPlayerSetAvatarNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.internal_static_BrickBreakerPlayerSetAvatarNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.internal_static_BrickBreakerPlayerSetAvatarNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify.class, emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify other = (emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.internal_static_BrickBreakerPlayerSetAvatarNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify build() {
        emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify buildPartial() {
        emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify result = new emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify other) {
        if (other == emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
      ...
      private void ensureCostumeIdListIsMutable() {
        if (!costumeIdList_.isModifiable()) {
          costumeIdList_ = makeMutableCopy(costumeIdList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify();
    }

    public static emu.protoshift.net.oldproto.BrickBreakerPlayerSetAvatarNotifyOuterClass.BrickBreakerPlayerSetAvatarNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "avatar_id_list\030\002 \003(\rB\035\n\033emu.protoshift.n" +
