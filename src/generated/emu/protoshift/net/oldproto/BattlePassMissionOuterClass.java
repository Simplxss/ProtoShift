...
public final class BattlePassMissionOuterClass {
  ...
  public interface BattlePassMissionOrBuilder extends
     ...
     */
    emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus getMissionStatus();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BattlePassMissionOuterClass.internal_static_BattlePassMission_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BattlePassMissionOuterClass.internal_static_BattlePassMission_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.class, emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.Builder.class);
    }
    ...
    public enum MissionStatus
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The missionStatus.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus getMissionStatus() {
      emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus result = emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus.forNumber(missionStatus_);
      return result == null ? emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (missionStatus_ != emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus.MISSION_STATUS_INVALID.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission other = (emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission) obj;
    ...
    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMissionOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BattlePassMissionOuterClass.internal_static_BattlePassMission_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission build() {
        emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission buildPartial() {
        emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission result = new emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission) {
          return mergeFrom((emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission other) {
        if (other == emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus getMissionStatus() {
        emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus result = emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus.forNumber(missionStatus_);
        return result == null ? emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setMissionStatus(emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission.MissionStatus value) {
        if (value == null) {
    ...
    private static final emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission();
    }

    public static emu.protoshift.net.oldproto.BattlePassMissionOuterClass.BattlePassMission getDefaultInstance() {
