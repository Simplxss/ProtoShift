...
public final class PersistentDungeonSwitchAvatarReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.internal_static_PersistentDungeonSwitchAvatarReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.internal_static_PersistentDungeonSwitchAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq.class, emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq other = (emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq) obj;
    ...
    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.internal_static_PersistentDungeonSwitchAvatarReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq build() {
        emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq buildPartial() {
        emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq result = new emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq) {
          return mergeFrom((emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq other) {
        if (other == emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq();
    }

    public static emu.protoshift.net.oldproto.PersistentDungeonSwitchAvatarReqOuterClass.PersistentDungeonSwitchAvatarReq getDefaultInstance() {
