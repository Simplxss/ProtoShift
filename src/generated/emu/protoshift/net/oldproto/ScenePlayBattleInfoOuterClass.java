...
public final class ScenePlayBattleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.internal_static_ScenePlayBattleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.internal_static_ScenePlayBattleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.class, emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo other = (emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.internal_static_ScenePlayBattleInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo build() {
        emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo buildPartial() {
        emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo result = new emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo other) {
        if (other == emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo();
    }

    public static emu.protoshift.net.oldproto.ScenePlayBattleInfoOuterClass.ScenePlayBattleInfo getDefaultInstance() {
