...
public final class FetterDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FetterDataOuterClass.internal_static_FetterData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FetterDataOuterClass.internal_static_FetterData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData.class, emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData other = (emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData) obj;
    ...
    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FetterDataOuterClass.internal_static_FetterData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData build() {
        emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData buildPartial() {
        emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData result = new emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData) {
          return mergeFrom((emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData other) {
        if (other == emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData();
    }

    public static emu.protoshift.net.oldproto.FetterDataOuterClass.FetterData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "d_index_list\030\003 \003(\rB\035\n\033emu.protoshift.net" +
      ".oldprotob\006proto3"
    };
