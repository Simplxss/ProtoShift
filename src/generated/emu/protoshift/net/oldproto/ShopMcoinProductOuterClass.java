...
public final class ShopMcoinProductOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.class, emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct other = (emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct) obj;
    ...
    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProductOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct build() {
        emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct buildPartial() {
        emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct result = new emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct) {
          return mergeFrom((emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct other) {
        if (other == emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct();
    }

    public static emu.protoshift.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct getDefaultInstance() {
