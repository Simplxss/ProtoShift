...
public final class GalleryFallCatchNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.internal_static_GalleryFallCatchNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.internal_static_GalleryFallCatchNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify.class, emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.internal_static_GalleryFallCatchNotify_BallCatchCountMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify other = (emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.internal_static_GalleryFallCatchNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify build() {
        emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify buildPartial() {
        emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify result = new emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify other) {
        if (other == emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify();
    }

    public static emu.protoshift.net.oldproto.GalleryFallCatchNotifyOuterClass.GalleryFallCatchNotify getDefaultInstance() {
