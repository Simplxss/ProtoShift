...
public final class FungusDetailOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FungusDetailOuterClass.internal_static_FungusDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FungusDetailOuterClass.internal_static_FungusDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail.class, emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail other = (emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail) obj;
    ...
    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FungusDetailOuterClass.internal_static_FungusDetail_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail build() {
        emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail buildPartial() {
        emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail result = new emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail) {
          return mergeFrom((emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail other) {
        if (other == emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail();
    }

    public static emu.protoshift.net.oldproto.FungusDetailOuterClass.FungusDetail getDefaultInstance() {
