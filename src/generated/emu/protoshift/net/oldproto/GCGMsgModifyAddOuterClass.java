...
public final class GCGMsgModifyAddOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.internal_static_GCGMsgModifyAdd_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.internal_static_GCGMsgModifyAdd_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd.class, emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd other = (emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAddOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.internal_static_GCGMsgModifyAdd_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd build() {
        emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd buildPartial() {
        emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd result = new emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd other) {
        if (other == emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
    ...
    private static final emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd();
    }

    public static emu.protoshift.net.oldproto.GCGMsgModifyAddOuterClass.GCGMsgModifyAdd getDefaultInstance() {
