...
public final class ScenePlayOwnerCheckRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.internal_static_ScenePlayOwnerCheckRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.internal_static_ScenePlayOwnerCheckRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp.class, emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp other = (emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.internal_static_ScenePlayOwnerCheckRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp build() {
        emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp buildPartial() {
        emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp result = new emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp other) {
        if (other == emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp();
    }

    public static emu.protoshift.net.oldproto.ScenePlayOwnerCheckRspOuterClass.ScenePlayOwnerCheckRsp getDefaultInstance() {
