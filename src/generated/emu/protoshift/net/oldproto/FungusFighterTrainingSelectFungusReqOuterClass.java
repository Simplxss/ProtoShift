...
public final class FungusFighterTrainingSelectFungusReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.internal_static_FungusFighterTrainingSelectFungusReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.internal_static_FungusFighterTrainingSelectFungusReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq.class, emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq other = (emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq) obj;
    ...
    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.internal_static_FungusFighterTrainingSelectFungusReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq build() {
        emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq buildPartial() {
        emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq result = new emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq) {
          return mergeFrom((emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq other) {
        if (other == emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq.getDefaultInstance()) return this;
      ...
      private void ensureFightFungusIdListIsMutable() {
        if (!fightFungusIdList_.isModifiable()) {
          fightFungusIdList_ = makeMutableCopy(fightFungusIdList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq();
    }

    public static emu.protoshift.net.oldproto.FungusFighterTrainingSelectFungusReqOuterClass.FungusFighterTrainingSelectFungusReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ight_fungus_id_list\030\013 \003(\rB\035\n\033emu.protosh" +
