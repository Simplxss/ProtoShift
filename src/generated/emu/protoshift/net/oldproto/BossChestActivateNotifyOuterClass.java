...
public final class BossChestActivateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.class, emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify other = (emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify build() {
        emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify buildPartial() {
        emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify result = new emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify other) {
        if (other == emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify();
    }

    public static emu.protoshift.net.oldproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\020qualify_uid_list\030\006 \003(\rB\035\n\033emu.protoshif" +
