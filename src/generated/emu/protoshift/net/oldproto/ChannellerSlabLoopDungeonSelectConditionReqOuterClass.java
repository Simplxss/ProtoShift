...
public final class ChannellerSlabLoopDungeonSelectConditionReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.internal_static_ChannellerSlabLoopDungeonSelectConditionReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.internal_static_ChannellerSlabLoopDungeonSelectConditionReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq.class, emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq other = (emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq) obj;
    ...
    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.internal_static_ChannellerSlabLoopDungeonSelectConditionReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq build() {
        emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq buildPartial() {
        emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq result = new emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq) {
          return mergeFrom((emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq other) {
        if (other == emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq();
    }

    public static emu.protoshift.net.oldproto.ChannellerSlabLoopDungeonSelectConditionReqOuterClass.ChannellerSlabLoopDungeonSelectConditionReq getDefaultInstance() {
