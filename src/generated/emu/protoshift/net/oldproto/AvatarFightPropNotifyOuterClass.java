...
public final class AvatarFightPropNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.internal_static_AvatarFightPropNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.internal_static_AvatarFightPropNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify.class, emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.internal_static_AvatarFightPropNotify_FightPropMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify other = (emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.internal_static_AvatarFightPropNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify build() {
        emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify buildPartial() {
        emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify result = new emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify other) {
        if (other == emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify();
    }

    public static emu.protoshift.net.oldproto.AvatarFightPropNotifyOuterClass.AvatarFightPropNotify getDefaultInstance() {
