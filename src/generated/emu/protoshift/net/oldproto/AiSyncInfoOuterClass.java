...
public final class AiSyncInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.AiSyncInfoOuterClass.internal_static_AiSyncInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.AiSyncInfoOuterClass.internal_static_AiSyncInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.class, emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo other = (emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.AiSyncInfoOuterClass.internal_static_AiSyncInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo build() {
        emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo buildPartial() {
        emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo result = new emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo other) {
        if (other == emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo();
    }

    public static emu.protoshift.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\027\n\017is_self_killing\030\001 \001(\010B\035\n\033emu.protoshi" +
