...
public final class PAKPHNDMDMFOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.internal_static_PAKPHNDMDMF_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.internal_static_PAKPHNDMDMF_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF.class, emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF other = (emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF) obj;
    ...
    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseFrom(
    ...
    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMFOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.internal_static_PAKPHNDMDMF_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF build() {
        emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF buildPartial() {
        emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF result = new emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF) {
          return mergeFrom((emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF other) {
        if (other == emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF();
    }

    public static emu.protoshift.net.oldproto.PAKPHNDMDMFOuterClass.PAKPHNDMDMF getDefaultInstance() {
