...
public final class GetOnlinePlayerInfoReqOuterClass {
  ...
  public interface GetOnlinePlayerInfoReqOrBuilder extends
    ...
    emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.PlayerIdCase getPlayerIdCase();
  }
  /**
   * <pre>
   * Obf: DNNMIGPCKOH
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.internal_static_GetOnlinePlayerInfoReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.internal_static_GetOnlinePlayerInfoReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.class, emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq other = (emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq) obj;
    ...
    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.internal_static_GetOnlinePlayerInfoReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq build() {
        emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq buildPartial() {
        emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq result = new emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq(this);
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq result) {
      ...
      private void buildPartialOneofs(emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq) {
          return mergeFrom((emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq other) {
        if (other == emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq();
    }

    public static emu.protoshift.net.oldproto.GetOnlinePlayerInfoReqOuterClass.GetOnlinePlayerInfoReq getDefaultInstance() {
