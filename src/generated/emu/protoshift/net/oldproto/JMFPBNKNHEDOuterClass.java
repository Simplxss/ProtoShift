...
public final class JMFPBNKNHEDOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.internal_static_JMFPBNKNHED_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.internal_static_JMFPBNKNHED_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED.class, emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED other = (emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED) obj;
    ...
    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseFrom(
    ...
    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseFrom(
    ...
    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHEDOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.internal_static_JMFPBNKNHED_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED build() {
        emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED buildPartial() {
        emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED result = new emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED) {
          return mergeFrom((emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED other) {
        if (other == emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED();
    }

    public static emu.protoshift.net.oldproto.JMFPBNKNHEDOuterClass.JMFPBNKNHED getDefaultInstance() {
