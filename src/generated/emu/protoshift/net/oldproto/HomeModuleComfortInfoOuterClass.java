...
public final class HomeModuleComfortInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.class, emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other = (emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo build() {
        emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo buildPartial() {
        emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = new emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other) {
        if (other == emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo();
    }

    public static emu.protoshift.net.oldproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstance() {
