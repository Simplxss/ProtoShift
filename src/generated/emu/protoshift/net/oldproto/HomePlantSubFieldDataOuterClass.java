...
public final class HomePlantSubFieldDataOuterClass {
  ...
  public interface HomePlantSubFieldDataOrBuilder extends
     ...
     * @return The status.
     */
    emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus getStatus();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.class, emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.Builder.class);
    }
     ...
     * @return The status.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus getStatus() {
      emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.forNumber(status_);
      return result == null ? emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (status_ != emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.HOME_FIELD_STATUE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other = (emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) obj;
    ...
    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData build() {
        emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData buildPartial() {
        emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result = new emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) {
          return mergeFrom((emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other) {
        if (other == emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus getStatus() {
        emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.forNumber(status_);
        return result == null ? emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setStatus(emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus value) {
        if (value == null) {
    ...
    private static final emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData();
    }

    public static emu.protoshift.net.oldproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "pe\030\003 \001(\rB\035\n\033emu.protoshift.net.oldprotob" +
      "\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.HomePlantFieldStatusOuterClass.getDescriptor(),
        });
    internal_static_HomePlantSubFieldData_descriptor =
