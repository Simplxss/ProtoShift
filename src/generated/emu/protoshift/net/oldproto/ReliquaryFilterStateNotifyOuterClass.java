...
public final class ReliquaryFilterStateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.internal_static_ReliquaryFilterStateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.internal_static_ReliquaryFilterStateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify.class, emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.internal_static_ReliquaryFilterStateNotify_ReliquaryFilterStateMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify other = (emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.internal_static_ReliquaryFilterStateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify build() {
        emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify buildPartial() {
        emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify result = new emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify other) {
        if (other == emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify();
    }

    public static emu.protoshift.net.oldproto.ReliquaryFilterStateNotifyOuterClass.ReliquaryFilterStateNotify getDefaultInstance() {
