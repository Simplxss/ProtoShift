...
public final class GameplayRecommendationSkillResponseOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.internal_static_GameplayRecommendationSkillResponse_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.internal_static_GameplayRecommendationSkillResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse.class, emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse other = (emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse) obj;
    ...
    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.internal_static_GameplayRecommendationSkillResponse_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse build() {
        emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse buildPartial() {
        emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse result = new emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse) {
          return mergeFrom((emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse other) {
        if (other == emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse();
    }

    public static emu.protoshift.net.oldproto.GameplayRecommendationSkillResponseOuterClass.GameplayRecommendationSkillResponse getDefaultInstance() {
