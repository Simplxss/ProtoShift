...
public final class BreakoutSyncConnectUidInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.class, emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo other = (emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo build() {
        emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo buildPartial() {
        emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo result = new emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo other) {
        if (other == emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo();
    }

    public static emu.protoshift.net.oldproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo getDefaultInstance() {
