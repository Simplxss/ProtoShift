...
public final class BlossomScheduleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.internal_static_BlossomScheduleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.internal_static_BlossomScheduleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.class, emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo other = (emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.internal_static_BlossomScheduleInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo build() {
        emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo buildPartial() {
        emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo result = new emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo other) {
        if (other == emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo();
    }

    public static emu.protoshift.net.oldproto.BlossomScheduleInfoOuterClass.BlossomScheduleInfo getDefaultInstance() {
