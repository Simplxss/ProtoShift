...
public final class QuestProgressUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.class, emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other = (emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify build() {
        emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify buildPartial() {
        emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = new emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other) {
        if (other == emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify();
    }

    public static emu.protoshift.net.oldproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstance() {
