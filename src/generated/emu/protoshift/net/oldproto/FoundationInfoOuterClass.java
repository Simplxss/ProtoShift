...
public final class FoundationInfoOuterClass {
  ...
  public interface FoundationInfoOrBuilder extends
     ...
     * @return The status.
     */
    emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus getStatus();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FoundationInfoOuterClass.internal_static_FoundationInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FoundationInfoOuterClass.internal_static_FoundationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo.class, emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo.Builder.class);
    }
     ...
     * @return The status.
     */
    @java.lang.Override public emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus getStatus() {
      emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus result = emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus.forNumber(status_);
      return result == null ? emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (status_ != emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus.FOUNDATION_STATUS_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo other = (emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FoundationInfoOuterClass.internal_static_FoundationInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo build() {
        emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo buildPartial() {
        emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo result = new emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo other) {
        if (other == emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo.getDefaultInstance()) return this;
        if (other.status_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus getStatus() {
        emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus result = emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus.forNumber(status_);
        return result == null ? emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setStatus(emu.protoshift.net.oldproto.FoundationStatusOuterClass.FoundationStatus value) {
        if (value == null) {
    ...
    private static final emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo();
    }

    public static emu.protoshift.net.oldproto.FoundationInfoOuterClass.FoundationInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "uid\030\004 \001(\rB\035\n\033emu.protoshift.net.oldproto" +
      "b\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.FoundationStatusOuterClass.getDescriptor(),
        });
    internal_static_FoundationInfo_descriptor =
