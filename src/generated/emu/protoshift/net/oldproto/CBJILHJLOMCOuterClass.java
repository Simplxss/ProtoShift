...
public final class CBJILHJLOMCOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.internal_static_CBJILHJLOMC_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.internal_static_CBJILHJLOMC_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC.class, emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC other = (emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC) obj;
    ...
    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseFrom(
    ...
    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseFrom(
    ...
    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMCOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.internal_static_CBJILHJLOMC_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC build() {
        emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC buildPartial() {
        emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC result = new emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC) {
          return mergeFrom((emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC other) {
        if (other == emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC();
    }

    public static emu.protoshift.net.oldproto.CBJILHJLOMCOuterClass.CBJILHJLOMC getDefaultInstance() {
