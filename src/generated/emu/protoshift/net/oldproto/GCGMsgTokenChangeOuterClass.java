...
public final class GCGMsgTokenChangeOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.internal_static_GCGMsgTokenChange_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.internal_static_GCGMsgTokenChange_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange.class, emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange other = (emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChangeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.internal_static_GCGMsgTokenChange_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange build() {
        emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange buildPartial() {
        emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange result = new emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange other) {
        if (other == emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange();
    }

    public static emu.protoshift.net.oldproto.GCGMsgTokenChangeOuterClass.GCGMsgTokenChange getDefaultInstance() {
