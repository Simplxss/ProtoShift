...
public final class EvtFixedRushMoveOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.internal_static_EvtFixedRushMove_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.internal_static_EvtFixedRushMove_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove.class, emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove other = (emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove) obj;
    ...
    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseFrom(
    ...
    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMoveOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.internal_static_EvtFixedRushMove_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove build() {
        emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove buildPartial() {
        emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove result = new emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove) {
          return mergeFrom((emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove other) {
        if (other == emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove();
    }

    public static emu.protoshift.net.oldproto.EvtFixedRushMoveOuterClass.EvtFixedRushMove getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "or\022\023\n\013CEIIFCMKJJC\030\r \001(\010B\035\n\033emu.protoshif" +
