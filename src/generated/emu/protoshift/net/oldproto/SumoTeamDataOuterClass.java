...
public final class SumoTeamDataOuterClass {
  ...
  public interface SumoTeamDataOrBuilder extends
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
     */
    emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
     */
     ...
     * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
     */
    emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.class, emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.Builder.class);
    }

    public static final int AVATAR_INFO_LIST_FIELD_NUMBER = 12;
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> avatarInfoList_;
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData other = (emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData) obj;
    ...
    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData build() {
        emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData buildPartial() {
        emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result = new emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result) {
        if (avatarInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData) {
          return mergeFrom((emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData other) {
        if (other == emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance()) return this;
        if (avatarInfoListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 98: {
                emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.parser(),
                        extensionRegistry);
                if (avatarInfoListBuilder_ == null) {
                  ensureAvatarInfoListIsMutable();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
       */
      public Builder addAvatarInfoList(emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarInfoList(
          emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
       */
      public emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
       */
      public emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
       */
      public emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 12;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
    ...
    private static final emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData();
    }

    public static emu.protoshift.net.oldproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.oldproto.SumoAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SumoTeamData_descriptor =
