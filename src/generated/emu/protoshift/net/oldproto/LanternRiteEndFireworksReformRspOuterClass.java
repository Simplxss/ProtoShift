...
public final class LanternRiteEndFireworksReformRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.internal_static_LanternRiteEndFireworksReformRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.internal_static_LanternRiteEndFireworksReformRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp.class, emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp.Builder.class);
    }
    ...
    private boolean hPLLPLKOHLL_ = false;
    /**
     * <code>bool HPLLPLKOHLL = 6;</code>
     * @return The hPLLPLKOHLL.
     */
    ...
    private boolean fBGNCOBOMAA_ = false;
    /**
     * <code>bool FBGNCOBOMAA = 9;</code>
     * @return The fBGNCOBOMAA.
     */
    ...
    private boolean hKBEDNIDDEI_ = false;
    /**
     * <code>bool HKBEDNIDDEI = 13;</code>
     * @return The hKBEDNIDDEI.
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp other = (emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.internal_static_LanternRiteEndFireworksReformRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp build() {
        emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp buildPartial() {
        emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp result = new emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp other) {
        if (other == emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp();
    }

    public static emu.protoshift.net.oldproto.LanternRiteEndFireworksReformRspOuterClass.LanternRiteEndFireworksReformRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\025\n\ris_new_record\030\013 \001(\010B\035\n\033emu.protoshi" +
