...
public final class SkipPlayerGameTimeReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.internal_static_SkipPlayerGameTimeReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.internal_static_SkipPlayerGameTimeReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq.class, emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq other = (emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq) obj;
    ...
    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.internal_static_SkipPlayerGameTimeReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq build() {
        emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq buildPartial() {
        emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq result = new emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq) {
          return mergeFrom((emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq other) {
        if (other == emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq();
    }

    public static emu.protoshift.net.oldproto.SkipPlayerGameTimeReqOuterClass.SkipPlayerGameTimeReq getDefaultInstance() {
