...
public final class IslandPartySailInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.class, emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify other = (emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify build() {
        emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify buildPartial() {
        emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify result = new emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify other) {
        if (other == emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify();
    }

    public static emu.protoshift.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify getDefaultInstance() {
