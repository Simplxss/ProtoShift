...
public final class GetAreaExplorePointRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.internal_static_GetAreaExplorePointRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.internal_static_GetAreaExplorePointRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp.class, emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp other = (emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.internal_static_GetAreaExplorePointRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp build() {
        emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp buildPartial() {
        emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp result = new emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp other) {
        if (other == emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp.getDefaultInstance()) return this;
      ...
      private void ensureExplorePointListIsMutable() {
        if (!explorePointList_.isModifiable()) {
          explorePointList_ = makeMutableCopy(explorePointList_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
    ...
    private static final emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp();
    }

    public static emu.protoshift.net.oldproto.GetAreaExplorePointRspOuterClass.GetAreaExplorePointRsp getDefaultInstance() {
