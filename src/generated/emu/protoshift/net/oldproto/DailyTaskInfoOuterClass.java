...
public final class DailyTaskInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.internal_static_DailyTaskInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.internal_static_DailyTaskInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo.class, emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo other = (emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.internal_static_DailyTaskInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo build() {
        emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo buildPartial() {
        emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo result = new emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo other) {
        if (other == emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo();
    }

    public static emu.protoshift.net.oldproto.DailyTaskInfoOuterClass.DailyTaskInfo getDefaultInstance() {
