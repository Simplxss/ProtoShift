...
public final class GcgPvePuzzleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.internal_static_GcgPvePuzzleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.internal_static_GcgPvePuzzleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo.class, emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo other = (emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.internal_static_GcgPvePuzzleInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo build() {
        emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo buildPartial() {
        emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo result = new emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo other) {
        if (other == emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo();
    }

    public static emu.protoshift.net.oldproto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo getDefaultInstance() {
