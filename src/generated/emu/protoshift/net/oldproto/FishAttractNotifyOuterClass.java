...
public final class FishAttractNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.internal_static_FishAttractNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.internal_static_FishAttractNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify.class, emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify other = (emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.internal_static_FishAttractNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify build() {
        emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify buildPartial() {
        emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify result = new emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify other) {
        if (other == emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify();
    }

    public static emu.protoshift.net.oldproto.FishAttractNotifyOuterClass.FishAttractNotify getDefaultInstance() {
