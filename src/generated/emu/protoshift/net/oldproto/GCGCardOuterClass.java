...
public final class GCGCardOuterClass {
  ...
  public interface GCGCardOrBuilder extends
     ...
     */
    java.util.List<emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken> 
        getTokenListList();
    /**
     * <code>repeated .GCGToken token_list = 1;</code>
     */
    emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken getTokenList(int index);
    /**
     * <code>repeated .GCGToken token_list = 1;</code>
     */
     ...
     * <code>repeated .GCGToken token_list = 1;</code>
     */
    java.util.List<? extends emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList();
    /**
     * <code>repeated .GCGToken token_list = 1;</code>
     */
    emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard.class, emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard.Builder.class);
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken> tokenList_;
    /**
     * <code>repeated .GCGToken token_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken> getTokenListList() {
      return tokenList_;
    }
    /**
     * <code>repeated .GCGToken token_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList() {
      return tokenList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken getTokenList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index) {
      return tokenList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard other = (emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard) obj;
    ...
    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCardOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard build() {
        emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard buildPartial() {
        emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard result = new emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard result) {
        if (skillLimitsListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard) {
          return mergeFrom((emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard other) {
        if (other == emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard.getDefaultInstance()) return this;
        if (skillLimitsListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken m =
                    input.readMessage(
                        emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.parser(),
                        extensionRegistry);
                if (tokenListBuilder_ == null) {
                  ensureTokenListIsMutable();
                  tokenList_.add(m);
      ...
      private void ensureTokenListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          tokenList_ = new java.util.ArrayList<emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken>(tokenList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> tokenListBuilder_;
      ...
      public Builder setTokenList(
          int index, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setTokenList(
          int index, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
       ...
       * <code>repeated .GCGToken token_list = 1;</code>
       */
      public Builder addTokenList(emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTokenList(
          emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
      ...
      public Builder addAllTokenList(
          java.lang.Iterable<? extends emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken> values) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, tokenList_);
       ...
       * <code>repeated .GCGToken token_list = 1;</code>
       */
      public emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder getTokenListBuilder(
          int index) {
       ...
       * <code>repeated .GCGToken token_list = 1;</code>
       */
      public emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder() {
        return getTokenListFieldBuilder().addBuilder(
            emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 1;</code>
       */
      public emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder(
          int index) {
        return getTokenListFieldBuilder().addBuilder(
            index, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 1;</code>
       */
      public java.util.List<emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder> 
           getTokenListBuilderList() {
        return getTokenListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGToken.Builder, emu.protoshift.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
    ...
    private static final emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard();
    }

    public static emu.protoshift.net.oldproto.GCGCardOuterClass.GCGCard getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.protoshift.net.oldproto.GCGTokenOuterClass.getDescriptor(),
        });
    internal_static_GCGCard_descriptor =
