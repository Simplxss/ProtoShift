...
public final class WinterCampTriathlonSettleNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.internal_static_WinterCampTriathlonSettleNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.internal_static_WinterCampTriathlonSettleNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify.class, emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify other = (emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.internal_static_WinterCampTriathlonSettleNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify build() {
        emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify buildPartial() {
        emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify result = new emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify other) {
        if (other == emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify();
    }

    public static emu.protoshift.net.oldproto.WinterCampTriathlonSettleNotifyOuterClass.WinterCampTriathlonSettleNotify getDefaultInstance() {
