...
public final class UseWidgetCreateGadgetReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.class, emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other = (emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) obj;
    ...
    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq build() {
        emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq buildPartial() {
        emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = new emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) {
          return mergeFrom((emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other) {
        if (other == emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance()) return this;
        if (other.hasRot()) {
    ...
    private static final emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq();
    }

    public static emu.protoshift.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\003pos\030\014 \001(\0132\007.VectorB\035\n\033emu.protoshift.ne" +
