...
public final class NightCrowGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.class, emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo other = (emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo build() {
        emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo buildPartial() {
        emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo result = new emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo other) {
        if (other == emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo();
    }

    public static emu.protoshift.net.oldproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo getDefaultInstance() {
