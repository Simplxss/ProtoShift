...
public final class BrickBreakerLevelInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.class, emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other = (emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) obj;
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo build() {
        emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo buildPartial() {
        emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = new emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) {
          return mergeFrom((emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other) {
        if (other == emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo();
    }

    public static emu.protoshift.net.oldproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\013 \001(\010\022\023\n\013JNFKFCEMOFM\030\010 \001(\010B\035\n\033emu.proto" +
