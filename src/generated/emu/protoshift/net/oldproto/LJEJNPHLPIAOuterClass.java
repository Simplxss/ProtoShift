...
public final class LJEJNPHLPIAOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.internal_static_LJEJNPHLPIA_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.internal_static_LJEJNPHLPIA_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA.class, emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA.Builder.class);
    }
    ...
    private boolean jLODFIIBEEI_ = false;
    /**
     * <code>bool JLODFIIBEEI = 8;</code>
     * @return The jLODFIIBEEI.
     */
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA other = (emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA) obj;
    ...
    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseFrom(
    ...
    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIAOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.internal_static_LJEJNPHLPIA_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA build() {
        emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA buildPartial() {
        emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA result = new emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA) {
          return mergeFrom((emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA other) {
        if (other == emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA.getDefaultInstance()) return this;
        if (other.getScore() != 0) {
    ...
    private static final emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA();
    }

    public static emu.protoshift.net.oldproto.LJEJNPHLPIAOuterClass.LJEJNPHLPIA getDefaultInstance() {
