...
public final class GetCompoundDataRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.internal_static_GetCompoundDataRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.internal_static_GetCompoundDataRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp.class, emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp other = (emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp) obj;
    ...
    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseFrom(
    ...
    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.internal_static_GetCompoundDataRsp_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp build() {
        emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp buildPartial() {
        emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp result = new emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp result) {
        if (compoundQueueDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp) {
          return mergeFrom((emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp other) {
        if (other == emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp();
    }

    public static emu.protoshift.net.oldproto.GetCompoundDataRspOuterClass.GetCompoundDataRsp getDefaultInstance() {
