...
public final class TowerLevelEndNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.internal_static_TowerLevelEndNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.internal_static_TowerLevelEndNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.class, emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.Builder.class);
    }
    ...
    public enum ContinueStateType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify other = (emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify) obj;
    ...
    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseFrom(
    ...
    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.internal_static_TowerLevelEndNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify getDefaultInstanceForType() {
        return emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify build() {
        emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify buildPartial() {
        emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify result = new emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify result) {
        if (rewardItemListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify) {
          return mergeFrom((emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify other) {
        if (other == emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify();
    }

    public static emu.protoshift.net.oldproto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify getDefaultInstance() {
