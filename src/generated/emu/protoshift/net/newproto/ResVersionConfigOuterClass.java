...
public final class ResVersionConfigOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.class, emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig other = (emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig) obj;
    ...
    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(
    ...
    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(
    ...
    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig build() {
        emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig buildPartial() {
        emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig result = new emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig) {
          return mergeFrom((emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig other) {
        if (other == emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig();
    }

    public static emu.protoshift.net.newproto.ResVersionConfigOuterClass.ResVersionConfig getDefaultInstance() {
