...
public final class AvatarSkillInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.class, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other = (emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) obj;
    ...
    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo build() {
        emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo buildPartial() {
        emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = new emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) {
          return mergeFrom((emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other) {
        if (other == emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo();
    }

    public static emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rge_count\030\003 \001(\r\022\024\n\014pass_cd_time\030\001 \001(\rB\035\n" +
