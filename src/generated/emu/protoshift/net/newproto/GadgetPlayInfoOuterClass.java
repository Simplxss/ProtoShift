...
public final class GadgetPlayInfoOuterClass {
  ...
  public interface GadgetPlayInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo getCrucibleInfo();
    /**
     * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
     */
    emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder getCrucibleInfoOrBuilder();
    ...
    emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.PlayInfoCase getPlayInfoCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.class, emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo getCrucibleInfo() {
      if (playInfoCase_ == 21) {
         return (emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_;
      }
      return emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance();
    }
    /**
     * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder getCrucibleInfoOrBuilder() {
      if (playInfoCase_ == 21) {
         return (emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_;
      }
      return emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (playInfoCase_ == 21) {
        output.writeMessage(21, (emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (playInfoCase_ == 21) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, (emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo other = (emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo) obj;
    ...
    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo build() {
        emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo buildPartial() {
        emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result = new emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo(this);
      ...
      private void buildPartial0(emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result) {
      ...
      private void buildPartialOneofs(emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo) {
          return mergeFrom((emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo other) {
        if (other == emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder> crucibleInfoBuilder_;
      /**
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       * @return Whether the crucibleInfo field is set.
       */
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public Builder setCrucibleInfo(emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo value) {
        if (crucibleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setCrucibleInfo(
          emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder builderForValue) {
        if (crucibleInfoBuilder_ == null) {
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public Builder mergeCrucibleInfo(emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo value) {
        if (crucibleInfoBuilder_ == null) {
          if (playInfoCase_ == 21 &&
              playInfo_ != emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance()) {
            playInfo_ = emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.newBuilder((emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_)
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder getCrucibleInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder> 
        ...
        if (crucibleInfoBuilder_ == null) {
          ...
          crucibleInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder>(
                  (emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_,
    ...
    private static final emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo();
    }

    public static emu.protoshift.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.newproto.GadgetCrucibleInfoOuterClass.getDescriptor(),
        });
    internal_static_GadgetPlayInfo_descriptor =
