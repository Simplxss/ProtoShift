...
public final class SetUpAvatarTeamReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.class, emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq other = (emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq) obj;
    ...
    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(
    ...
    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(
    ...
    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq build() {
        emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq buildPartial() {
        emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq result = new emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq) {
          return mergeFrom((emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq other) {
        if (other == emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq();
    }

    public static emu.protoshift.net.newproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rTeamReq\022\017\n\007team_id\030\004 \001(\r\022\035\n\025avatar_team" +
      "_guid_list\030\013 \003(\004\022\027\n\017cur_avatar_guid\030\017 \001(" +
