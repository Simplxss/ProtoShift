...
public final class EntityRendererChangedInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.class, emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.String, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.String, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_ChangedRenderersEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo other = (emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo) obj;
    ...
    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.internal_static_EntityRendererChangedInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo build() {
        emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo buildPartial() {
        emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo result = new emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo) {
          return mergeFrom((emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo other) {
        if (other == emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo();
    }

    public static emu.protoshift.net.newproto.EntityRendererChangedInfoOuterClass.EntityRendererChangedInfo getDefaultInstance() {
