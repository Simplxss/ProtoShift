...
public final class LifeStateChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.internal_static_LifeStateChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.internal_static_LifeStateChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify.class, emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify other = (emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify) obj;
    ...
    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.internal_static_LifeStateChangeNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify build() {
        emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify buildPartial() {
        emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify result = new emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify result) {
        if (serverBuffListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify) {
          return mergeFrom((emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify other) {
        if (other == emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify();
    }

    public static emu.protoshift.net.newproto.LifeStateChangeNotifyOuterClass.LifeStateChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ver_buff_list\030\014 \003(\0132\013.ServerBuff\022\030\n\020sour" +
      "ce_entity_id\030\004 \001(\r\022\031\n\021move_reliable_seq\030" +
      "\017 \001(\r\022\022\n\nattack_tag\030\n \001(\t\022 \n\010die_type\030\013 " +
      "\001(\0162\016.PlayerDieType\022\022\n\nlife_state\030\007 \001(\rB" +
