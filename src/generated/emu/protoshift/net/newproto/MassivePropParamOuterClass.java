...
public final class MassivePropParamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.MassivePropParamOuterClass.internal_static_MassivePropParam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.MassivePropParamOuterClass.internal_static_MassivePropParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam.class, emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam other = (emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam) obj;
    ...
    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseFrom(
    ...
    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseFrom(
    ...
    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.MassivePropParamOuterClass.internal_static_MassivePropParam_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam build() {
        emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam buildPartial() {
        emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam result = new emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam) {
          return mergeFrom((emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam other) {
        if (other == emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam();
    }

    public static emu.protoshift.net.newproto.MassivePropParamOuterClass.MassivePropParam getDefaultInstance() {
