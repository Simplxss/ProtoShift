...
public final class AbilityMixinRecoverInfoOuterClass {
  ...
  public interface AbilityMixinRecoverInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot getBreakoutSnapShot();
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     */
    emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder();
     ...
     */
    java.util.List<emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> 
        getMassivePropListList();
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo getMassivePropList(int index);
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
     ...
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    java.util.List<? extends emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
        getMassivePropListOrBuilderList();
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder getMassivePropListOrBuilder(
        int index);
    ...
    emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.SourceCase getSourceCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.class, emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.Builder.class);
    }
    ...
    private emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot breakoutSnapShot_;
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     * @return Whether the breakoutSnapShot field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot getBreakoutSnapShot() {
      return breakoutSnapShot_ == null ? emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : breakoutSnapShot_;
    }
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder() {
      return breakoutSnapShot_ == null ? emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : breakoutSnapShot_;
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> massivePropList_;
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> getMassivePropListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
        getMassivePropListOrBuilderList() {
      return massivePropList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo getMassivePropList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder getMassivePropListOrBuilder(
        int index) {
      return massivePropList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo other = (emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo) obj;
    ...
    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo build() {
        emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo buildPartial() {
        emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result = new emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result) {
        if (massivePropListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result) {
      ...
      private void buildPartialOneofs(emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo) {
          return mergeFrom((emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo other) {
        if (other == emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo m =
                    input.readMessage(
                        emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.parser(),
                        extensionRegistry);
                if (massivePropListBuilder_ == null) {
                  ensureMassivePropListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot, emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder, emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder> breakoutSnapShotBuilder_;
      /**
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       * @return Whether the breakoutSnapShot field is set.
       */
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public Builder setBreakoutSnapShot(emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
        if (breakoutSnapShotBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setBreakoutSnapShot(
          emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder builderForValue) {
        if (breakoutSnapShotBuilder_ == null) {
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public Builder mergeBreakoutSnapShot(emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
        if (breakoutSnapShotBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            breakoutSnapShot_ != null &&
            breakoutSnapShot_ != emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance()) {
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder getBreakoutSnapShotBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
      ...
      public emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder() {
        if (breakoutSnapShotBuilder_ != null) {
          ...
          return breakoutSnapShot_ == null ?
              emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : breakoutSnapShot_;
        }
      }
      /**
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot, emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder, emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder> 
          getBreakoutSnapShotFieldBuilder() {
        if (breakoutSnapShotBuilder_ == null) {
      ...
      private void ensureMassivePropListIsMutable() {
        if (!((bitField0_ & 0x00000010) != 0)) {
          massivePropList_ = new java.util.ArrayList<emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo>(massivePropList_);
          bitField0_ |= 0x00000010;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> massivePropListBuilder_;
      ...
      public Builder setMassivePropList(
          int index, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo value) {
        if (massivePropListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setMassivePropList(
          int index, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder builderForValue) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public Builder addMassivePropList(emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo value) {
        if (massivePropListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addMassivePropList(
          emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder builderForValue) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
      ...
      public Builder addAllMassivePropList(
          java.lang.Iterable<? extends emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> values) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder getMassivePropListBuilder(
          int index) {
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder addMassivePropListBuilder() {
        return getMassivePropListFieldBuilder().addBuilder(
            emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder addMassivePropListBuilder(
          int index) {
        return getMassivePropListFieldBuilder().addBuilder(
            index, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public java.util.List<emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder> 
           getMassivePropListBuilderList() {
        return getMassivePropListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder, emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
          getMassivePropListFieldBuilder() {
        if (massivePropListBuilder_ == null) {
    ...
    private static final emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo();
    }

    public static emu.protoshift.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.newproto.BreakoutSnapShotOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.MassivePropSyncInfoOuterClass.getDescriptor(),
        });
    internal_static_AbilityMixinRecoverInfo_descriptor =
