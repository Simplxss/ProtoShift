...
public final class BreakoutPhysicalObjectModifierOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.class, emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier other = (emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier) obj;
    ...
    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier build() {
        emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier buildPartial() {
        emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier result = new emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier) {
          return mergeFrom((emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier other) {
        if (other == emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.getDefaultInstance()) return this;
        if (other.getType() != 0) {
    ...
    private static final emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier();
    }

    public static emu.protoshift.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\014 \001(\r\022\016\n\006param1\030\003 \001(\005B\035\n\033emu.protoshift" +
