...
public final class BlockInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.BlockInfoOuterClass.internal_static_BlockInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.BlockInfoOuterClass.internal_static_BlockInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo.class, emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo other = (emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo) obj;
    ...
    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.BlockInfoOuterClass.internal_static_BlockInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo build() {
        emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo buildPartial() {
        emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo result = new emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo) {
          return mergeFrom((emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo other) {
        if (other == emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo();
    }

    public static emu.protoshift.net.newproto.BlockInfoOuterClass.BlockInfo getDefaultInstance() {
