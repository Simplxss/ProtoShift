...
emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam defaultValue);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.internal_static_AvatarTeamUpdateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.internal_static_AvatarTeamUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify.class, emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam> defaultEntry =
              ...
              .<java.lang.Integer, emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.internal_static_AvatarTeamUpdateNotify_AvatarTeamMapEntry_descriptor, 
...
emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam defaultValue) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify other = (emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify) obj;
    ...
    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.internal_static_AvatarTeamUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify build() {
        emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify buildPartial() {
        emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify result = new emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify) {
          return mergeFrom((emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify other) {
        if (other == emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify.getDefaultInstance()) return this;
...
emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam defaultValue) {
    ...
    private static final emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify();
    }

    public static emu.protoshift.net.newproto.AvatarTeamUpdateNotifyOuterClass.AvatarTeamUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "emp_avatar_guid_list\030\006 \003(\004\022C\n\017avatar_tea" +
