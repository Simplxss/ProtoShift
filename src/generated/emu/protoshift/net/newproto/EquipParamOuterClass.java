...
public final class EquipParamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.EquipParamOuterClass.internal_static_EquipParam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.EquipParamOuterClass.internal_static_EquipParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam.class, emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam other = (emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam) obj;
    ...
    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseFrom(
    ...
    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseFrom(
    ...
    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.EquipParamOuterClass.EquipParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.EquipParamOuterClass.internal_static_EquipParam_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam build() {
        emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam buildPartial() {
        emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam result = new emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam) {
          return mergeFrom((emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam other) {
        if (other == emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam();
    }

    public static emu.protoshift.net.newproto.EquipParamOuterClass.EquipParam getDefaultInstance() {
