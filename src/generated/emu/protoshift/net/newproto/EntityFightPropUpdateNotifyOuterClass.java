...
public final class EntityFightPropUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.class, emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_FightPropMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify other = (emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify) obj;
    ...
    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify build() {
        emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify buildPartial() {
        emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify result = new emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify) {
          return mergeFrom((emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify other) {
        if (other == emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify();
    }

    public static emu.protoshift.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e\030\002 \001(\002:\0028\001B\035\n\033emu.protoshift.net.newpro" +
      "tob\006proto3"
    };
