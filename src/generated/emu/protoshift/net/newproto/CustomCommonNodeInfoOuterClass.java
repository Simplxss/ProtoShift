...
public final class CustomCommonNodeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.class, emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo other = (emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo) obj;
    ...
    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo build() {
        emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo buildPartial() {
        emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo result = new emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo) {
          return mergeFrom((emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo other) {
        if (other == emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo();
    }

    public static emu.protoshift.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo getDefaultInstance() {
