...
public final class SocialDetailOuterClass {
  ...
  public interface SocialDetailOrBuilder extends
     ...
     * @return The birthday.
     */
    emu.protoshift.net.newproto.BirthdayOuterClass.Birthday getBirthday();
    /**
     * <code>.Birthday birthday = 6;</code>
     */
    emu.protoshift.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder();
     ...
     */
    emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState();
     ...
     */
    java.util.List<emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
     ...
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    java.util.List<? extends emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
     ...
     */
    emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail.class, emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail.Builder.class);
    }
    ...
    private emu.protoshift.net.newproto.BirthdayOuterClass.Birthday birthday_;
    /**
     * <code>.Birthday birthday = 6;</code>
     * @return Whether the birthday field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.BirthdayOuterClass.Birthday getBirthday() {
      return birthday_ == null ? emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
    }
    /**
     * <code>.Birthday birthday = 6;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder() {
      return birthday_ == null ? emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
    }
     ...
     * @return The onlineState.
     */
    @java.lang.Override public emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
      emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.forNumber(onlineState_);
      return result == null ? emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
    }
    ...
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> showAvatarInfoList_;
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
     ...
     * @return The friendEnterHomeOption.
     */
    @java.lang.Override public emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
      emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.forNumber(friendEnterHomeOption_);
      return result == null ? emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (onlineState_ != emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.FriendOnlineState_FreiendDisconnect.getNumber()) {
      ...
      if (friendEnterHomeOption_ != emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.FriendEnterHomeOption_NeedConfirm.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail other = (emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail) obj;
    ...
    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail build() {
        emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail buildPartial() {
        emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail result = new emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail result) {
        if (showAvatarInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail) {
          return mergeFrom((emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail other) {
        if (other == emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo m =
                    input.readMessage(
                        emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.parser(),
                        extensionRegistry);
                if (showAvatarInfoListBuilder_ == null) {
                  ensureShowAvatarInfoListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.BirthdayOuterClass.Birthday, emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.Builder, emu.protoshift.net.newproto.BirthdayOuterClass.BirthdayOrBuilder> birthdayBuilder_;
      /**
       * <code>.Birthday birthday = 6;</code>
       * @return Whether the birthday field is set.
       */
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public Builder setBirthday(emu.protoshift.net.newproto.BirthdayOuterClass.Birthday value) {
        if (birthdayBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setBirthday(
          emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.Builder builderForValue) {
        if (birthdayBuilder_ == null) {
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public Builder mergeBirthday(emu.protoshift.net.newproto.BirthdayOuterClass.Birthday value) {
        if (birthdayBuilder_ == null) {
          if (((bitField0_ & 0x00000020) != 0) &&
            birthday_ != null &&
            birthday_ != emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance()) {
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.Builder getBirthdayBuilder() {
        bitField0_ |= 0x00000020;
        onChanged();
      ...
      public emu.protoshift.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder() {
        if (birthdayBuilder_ != null) {
          ...
          return birthday_ == null ?
              emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
        }
      }
      /**
       * <code>.Birthday birthday = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.BirthdayOuterClass.Birthday, emu.protoshift.net.newproto.BirthdayOuterClass.Birthday.Builder, emu.protoshift.net.newproto.BirthdayOuterClass.BirthdayOrBuilder> 
          getBirthdayFieldBuilder() {
        if (birthdayBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
        emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.forNumber(onlineState_);
        return result == null ? emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setOnlineState(emu.protoshift.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000100;
      ...
      private void ensureShowAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00200000) != 0)) {
          showAvatarInfoList_ = new java.util.ArrayList<emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo>(showAvatarInfoList_);
          bitField0_ |= 0x00200000;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public Builder addShowAvatarInfoList(emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShowAvatarInfoList(
          emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public java.util.List<emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder> 
           getShowAvatarInfoListBuilderList() {
        return getShowAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
          getShowAvatarInfoListFieldBuilder() {
        if (showAvatarInfoListBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
        emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.forNumber(friendEnterHomeOption_);
        return result == null ? emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setFriendEnterHomeOption(emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00800000;
    ...
    private static final emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail();
    }

    public static emu.protoshift.net.newproto.SocialDetailOuterClass.SocialDetail getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "de\030\032 \001(\tB\035\n\033emu.protoshift.net.newprotob" +
      "\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.protoshift.net.newproto.BirthdayOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.FriendOnlineStateOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.SocialShowAvatarInfoOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.FriendEnterHomeOptionOuterClass.getDescriptor(),
