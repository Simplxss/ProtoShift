...
public final class AvatarTeamOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AvatarTeamOuterClass.internal_static_AvatarTeam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.AvatarTeamOuterClass.internal_static_AvatarTeam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam.class, emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam other = (emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam) obj;
    ...
    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AvatarTeamOuterClass.internal_static_AvatarTeam_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam build() {
        emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam buildPartial() {
        emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam result = new emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam) {
          return mergeFrom((emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam other) {
        if (other == emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam();
    }

    public static emu.protoshift.net.newproto.AvatarTeamOuterClass.AvatarTeam getDefaultInstance() {
