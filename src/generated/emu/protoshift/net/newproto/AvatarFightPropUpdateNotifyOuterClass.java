...
public final class AvatarFightPropUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.internal_static_AvatarFightPropUpdateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.internal_static_AvatarFightPropUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify.class, emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.internal_static_AvatarFightPropUpdateNotify_FightPropMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify other = (emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify) obj;
    ...
    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.internal_static_AvatarFightPropUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify build() {
        emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify buildPartial() {
        emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify result = new emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify) {
          return mergeFrom((emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify other) {
        if (other == emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify();
    }

    public static emu.protoshift.net.newproto.AvatarFightPropUpdateNotifyOuterClass.AvatarFightPropUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lue\030\002 \001(\002:\0028\001B\035\n\033emu.protoshift.net.newp" +
      "rotob\006proto3"
    };
