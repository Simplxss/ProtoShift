...
public final class AvatarInfoOuterClass {
  ...
  public interface AvatarInfoOrBuilder extends
     ...
     */
    emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getTrialAvatarInfo();
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     */
    emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder();
     ...
     */
    emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getExcelInfo();
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     */
    emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder();
    ...
    java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    getSkillMap();
    /**
     * <code>map&lt;uint32, .AvatarSkillInfo&gt; skill_map = 10;</code>
     */
     ...
     */
    /* nullable */
emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrDefault(
        int key,
        /* nullable */
emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo defaultValue);
    /**
     * <code>map&lt;uint32, .AvatarSkillInfo&gt; skill_map = 10;</code>
     */
    emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrThrow(
        int key);
...
emu.protoshift.net.newproto.PropValueOuterClass.PropValue defaultValue);
     ...
     */
    java.util.List<emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> 
        getEquipAffixListList();
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo getEquipAffixList(int index);
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
     ...
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    java.util.List<? extends emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
        getEquipAffixListOrBuilderList();
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder getEquipAffixListOrBuilder(
        int index);
     ...
     */
    emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getFetterInfo();
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     */
    emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder();
     ...
     */
    emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo.class, emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo.Builder.class);
    }

    private int bitField0_;
    public static final int TRIAL_AVATAR_INFO_FIELD_NUMBER = 9;
    private emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo trialAvatarInfo_;
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     * @return Whether the trialAvatarInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getTrialAvatarInfo() {
      return trialAvatarInfo_ == null ? emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance() : trialAvatarInfo_;
    }
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder() {
      return trialAvatarInfo_ == null ? emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance() : trialAvatarInfo_;
    }

    public static final int EXCEL_INFO_FIELD_NUMBER = 26;
    private emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo excelInfo_;
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     * @return Whether the excelInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getExcelInfo() {
      return excelInfo_ == null ? emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance() : excelInfo_;
    }
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder() {
      return excelInfo_ == null ? emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance() : excelInfo_;
    }
    ...
    private static final class SkillMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_SkillMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance());
    }
    @SuppressWarnings("serial")
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> skillMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    internalGetSkillMap() {
      if (skillMap_ == null) {
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> getSkillMap() {
     ...
     */
    @java.lang.Override
    public java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> getSkillMapMap() {
...
emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo defaultValue) {
      ...
      java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> map =
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrThrow(
        int key) {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_FightPropMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_SkillLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.protoshift.net.newproto.PropValueOuterClass.PropValue> defaultEntry =
              ...
              .<java.lang.Integer, emu.protoshift.net.newproto.PropValueOuterClass.PropValue>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_PropMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
...
emu.protoshift.net.newproto.PropValueOuterClass.PropValue defaultValue) {
    ...
    @SuppressWarnings("serial")
    private java.util.List<emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> equipAffixList_;
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> getEquipAffixListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
        getEquipAffixListOrBuilderList() {
      return equipAffixList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo getEquipAffixList(int index) {
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder getEquipAffixListOrBuilder(
        int index) {
      return equipAffixList_.get(index);
    }
    ...
    private static final class ProudSkillExtraLevelMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_ProudSkillExtraLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    private emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo fetterInfo_;
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     * @return Whether the fetterInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getFetterInfo() {
      return fetterInfo_ == null ? emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance() : fetterInfo_;
    }
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     */
    @java.lang.Override
    public emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder() {
      return fetterInfo_ == null ? emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance() : fetterInfo_;
    }
     ...
     * @return The expeditionState.
     */
    @java.lang.Override public emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState() {
      emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState result = emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.forNumber(expeditionState_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          SkillLevelMapDefaultEntryHolder.defaultEntry,
          15);
      if (expeditionState_ != emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.AVATAR_EXPEDITION_NONE.getNumber()) {
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> entry
           : internalGetSkillMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo other = (emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo) obj;
    ...
    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo build() {
        emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo buildPartial() {
        emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo result = new emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo(this);
      ...
      private void buildPartialRepeatedFields(emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo result) {
        if (equipAffixListBuilder_ == null) {
      ...
      private void buildPartial0(emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo) {
          return mergeFrom((emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo other) {
        if (other == emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo m =
                    input.readMessage(
                        emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.parser(),
                        extensionRegistry);
                if (equipAffixListBuilder_ == null) {
                  ensureEquipAffixListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo, emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder, emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder> trialAvatarInfoBuilder_;
      /**
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       * @return Whether the trialAvatarInfo field is set.
       */
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public Builder setTrialAvatarInfo(emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo value) {
        if (trialAvatarInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setTrialAvatarInfo(
          emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder builderForValue) {
        if (trialAvatarInfoBuilder_ == null) {
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public Builder mergeTrialAvatarInfo(emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo value) {
        if (trialAvatarInfoBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            trialAvatarInfo_ != null &&
            trialAvatarInfo_ != emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance()) {
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder getTrialAvatarInfoBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
      ...
      public emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder() {
        if (trialAvatarInfoBuilder_ != null) {
          ...
          return trialAvatarInfo_ == null ?
              emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance() : trialAvatarInfo_;
        }
      }
      /**
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo, emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder, emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder> 
          getTrialAvatarInfoFieldBuilder() {
        if (trialAvatarInfoBuilder_ == null) {
      ...
      private emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo excelInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo, emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder, emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder> excelInfoBuilder_;
      /**
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       * @return Whether the excelInfo field is set.
       */
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public Builder setExcelInfo(emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo value) {
        if (excelInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setExcelInfo(
          emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder builderForValue) {
        if (excelInfoBuilder_ == null) {
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public Builder mergeExcelInfo(emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo value) {
        if (excelInfoBuilder_ == null) {
          if (((bitField0_ & 0x00000002) != 0) &&
            excelInfo_ != null &&
            excelInfo_ != emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance()) {
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder getExcelInfoBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
      ...
      public emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder() {
        if (excelInfoBuilder_ != null) {
          ...
          return excelInfo_ == null ?
              emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance() : excelInfo_;
        }
      }
      /**
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo, emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder, emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder> 
          getExcelInfoFieldBuilder() {
        if (excelInfoBuilder_ == null) {
...
emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo defaultValue) {
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
          getMutableSkillMap() {
        bitField0_ |= 0x00000004;
      ...
      public Builder putSkillMap(
          int key,
          emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo value) {
      ...
      public Builder putAllSkillMap(
          java.util.Map<java.lang.Integer, emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> values) {
        internalGetMutableSkillMap().getMutableMap()
            .putAll(values);
        bitField0_ |= 0x00000004;
        return this;
...
emu.protoshift.net.newproto.PropValueOuterClass.PropValue defaultValue) {
      ...
      private void ensureEquipAffixListIsMutable() {
        if (!((bitField0_ & 0x00000400) != 0)) {
          equipAffixList_ = new java.util.ArrayList<emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo>(equipAffixList_);
          bitField0_ |= 0x00000400;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> equipAffixListBuilder_;
      ...
      public Builder setEquipAffixList(
          int index, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo value) {
        if (equipAffixListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setEquipAffixList(
          int index, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder builderForValue) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public Builder addEquipAffixList(emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo value) {
        if (equipAffixListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addEquipAffixList(
          emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder builderForValue) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
      ...
      public Builder addAllEquipAffixList(
          java.lang.Iterable<? extends emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> values) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder getEquipAffixListBuilder(
          int index) {
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder addEquipAffixListBuilder() {
        return getEquipAffixListFieldBuilder().addBuilder(
            emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder addEquipAffixListBuilder(
          int index) {
        return getEquipAffixListFieldBuilder().addBuilder(
            index, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public java.util.List<emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder> 
           getEquipAffixListBuilderList() {
        return getEquipAffixListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder, emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
          getEquipAffixListFieldBuilder() {
        if (equipAffixListBuilder_ == null) {
      ...
      private emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo fetterInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo, emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder, emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder> fetterInfoBuilder_;
      /**
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       * @return Whether the fetterInfo field is set.
       */
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public Builder setFetterInfo(emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo value) {
        if (fetterInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFetterInfo(
          emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder builderForValue) {
        if (fetterInfoBuilder_ == null) {
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public Builder mergeFetterInfo(emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo value) {
        if (fetterInfoBuilder_ == null) {
          if (((bitField0_ & 0x00002000) != 0) &&
            fetterInfo_ != null &&
            fetterInfo_ != emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance()) {
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder getFetterInfoBuilder() {
        bitField0_ |= 0x00002000;
        onChanged();
      ...
      public emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder() {
        if (fetterInfoBuilder_ != null) {
          ...
          return fetterInfo_ == null ?
              emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance() : fetterInfo_;
        }
      }
      /**
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo, emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder, emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder> 
          getFetterInfoFieldBuilder() {
        if (fetterInfoBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState() {
        emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState result = emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.forNumber(expeditionState_);
        return result == null ? emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setExpeditionState(emu.protoshift.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00800000;
    ...
    private static final emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo();
    }

    public static emu.protoshift.net.newproto.AvatarInfoOuterClass.AvatarInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.protoshift.net.newproto.TrialAvatarInfoOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.AvatarEquipAffixInfoOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.AvatarExcelInfoOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.AvatarSkillInfoOuterClass.getDescriptor(),
          emu.protoshift.net.newproto.AvatarFetterInfoOuterClass.getDescriptor(),
