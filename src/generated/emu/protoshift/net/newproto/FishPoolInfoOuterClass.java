...
public final class FishPoolInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.protoshift.net.newproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.protoshift.net.newproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo.class, emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo)) {
        return super.equals(obj);
      }
      emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo other = (emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo) obj;
    ...
    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(
    ...
    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.protoshift.net.newproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_descriptor;
      }
      ...
      // Construct using emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo getDefaultInstanceForType() {
        return emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo build() {
        emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo buildPartial() {
        emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo result = new emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo) {
          return mergeFrom((emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo other) {
        if (other == emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo.getDefaultInstance()) return this;
    ...
    private static final emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo();
    }

    public static emu.protoshift.net.newproto.FishPoolInfoOuterClass.FishPoolInfo getDefaultInstance() {
