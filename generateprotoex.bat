...
.\tools\protoc\protoc.exe -I=".\proto\%NewVersion%" --java_out=".\src\generated" ".\proto\%NewVersion%\*.proto"
.\tools\protoc\protoc.exe -I=".\proto\%OldVersion%" --java_out=".\src\generated" ".\proto\%OldVersion%\*.proto"
